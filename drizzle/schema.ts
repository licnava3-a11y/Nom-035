...
export const companies = mysqlTable("companies", {
  ...
  // Plan y estado
  plan: mysqlEnum("plan", ["trial", "basic", "professional", "enterprise"])
    .default("trial")
    .notNull(),
  ...
  conflictThreshold: decimal("conflict_threshold", {
    precision: 5,
    scale: 2,
  }).default("30.00"), // % de ausencias simultáneas para alerta
...
export const users = mysqlTable("users", {
  ...
  tipoContrato: mysqlEnum("tipoContrato", [
    "Planta",
    "Temporal",
    "Por obra",
    "Honorarios",
  ...
  jornadaLaboral: mysqlEnum("jornadaLaboral", [
    "Diurna",
    "Nocturna",
    "Mixta",
    "Por turnos",
  ...
  nivelJerarquico: mysqlEnum("nivelJerarquico", [
    "Operativo",
    "Especialista",
    "Supervisor",
    "Gerencial",
...
export const cases = mysqlTable("cases", {
  ...
  status: mysqlEnum("status", ["open", "investigating", "resolved", "closed"])
    .default("open")
    .notNull(),
...
export const jobPositions = mysqlTable("jobPositions", {
  ...
  catalogPositionId: int("catalogPositionId").references(() => positions.id, {
    onDelete: "set null",
  }),
...
export const performanceEvaluations = mysqlTable("performanceEvaluations", {
  ...
  workEnvironmentScore: decimal("workEnvironmentScore", {
    precision: 5,
    scale: 2,
  }),
...
export type InsertPerformanceEvaluation =
  typeof performanceEvaluations.$inferInsert;
...
export const mailbox = mysqlTable("mailbox", {
  ...
  priority: mysqlEnum("priority", ["low", "medium", "high", "urgent"])
    .default("medium")
    .notNull(),
  receivedVia: mysqlEnum("receivedVia", ["email", "web_form"])
    .default("web_form")
    .notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
...
export const notifications = mysqlTable("notifications", {
  ...
  type: mysqlEnum("type", [
    ...
    "committee", // Notificaciones del comité
...
export const caseAssignments = mysqlTable("caseAssignments", {
  ...
  role: mysqlEnum("role", ["lead", "support", "observer"])
    .default("support")
    .notNull(),
...
export const positions = mysqlTable("positions", {
  ...
  minimumEducation: mysqlEnum("minimumEducation", [
    "primaria",
    "secundaria",
    "preparatoria",
    "tecnico",
...
export const employeeHistory = mysqlTable("employeeHistory", {
  ...
  terminationCategory: mysqlEnum("terminationCategory", [
    "voluntary",
    "involuntary",
    "legal",
  ]),
...
export const documents = mysqlTable("documents", {
  id: int("id").primaryKey().autoincrement(),
  formatCatalogId: int("format_catalog_id")
    .notNull()
...
export const documentParticipantsRelations = relations(
...
export const documentEvidenceRelations = relations(
  documentEvidence,
  ({ one }) => ({
    document: one(documents, {
...
export const surveyPeriods = mysqlTable("survey_periods", {
  ...
  surveyType: mysqlEnum("survey_type", [
    "guia_i",
    "guia_ii",
    "guia_iii",
  ]).notNull(),
...
export const surveyTokens = mysqlTable("survey_tokens", {
  ...
  periodId: int("period_id")
    .notNull()
    .references(() => surveyPeriods.id), // Periodo de aplicación
  userId: int("user_id")
    .notNull()
    .references(() => users.id),
  surveyId: int("survey_id")
...
export const surveyPeriodsRelations = relations(
  surveyPeriods,
  ({ one, many }) => ({
    creator: one(users, {
...
export const correctiveActions = mysqlTable(
  "correctiveActions",
  {
    ...
    actionLevel: mysqlEnum("actionLevel", [
      "organizacional",
      "grupal",
      "individual",
    ]).notNull(), // Nivel de la acción
    ...
    clinicalTitle: mysqlEnum("clinicalTitle", [
      "medico",
      "psicologo",
      "psiquiatra",
    ]),
  ...
  table => [
    index("idx_corrective_actions_status_due_date").on(
      table.status,
      table.dueDate
    ),
    index("idx_corrective_actions_responsible_user_id").on(
      table.responsibleUserId
    ),
    index("idx_corrective_actions_survey_response_id").on(
...
export const surveyNotificationsRelations = relations(
  surveyNotifications,
  ({ one }) => ({
    survey: one(surveys, {
...
export const employeeDocuments = mysqlTable("employeeDocuments", {
  ...
  status: mysqlEnum("status", ["vigente", "por_vencer", "vencido"])
    .default("vigente")
    .notNull(),
...
export const jobProfiles = mysqlTable("jobProfiles", {
  ...
  competencyType: mysqlEnum("competencyType", [
    "tecnica",
    "transversal",
    "conocimiento",
  ]).notNull(),
  requiredLevel: mysqlEnum("requiredLevel", [
    "basico",
    "intermedio",
    "avanzado",
    "experto",
 ...
 */
export const organizationalCompetencies = mysqlTable(
...
export type OrganizationalCompetency =
  typeof organizationalCompetencies.$inferSelect;
export type InsertOrganizationalCompetency =
  typeof organizationalCompetencies.$inferInsert;
...
export const employeeCompetenciesRelations = relations(
...
export const meetingMinutesRelations = relations(
  meetingMinutes,
  ({ many }) => ({
...
export const meetingAttachmentsRelations = relations(
  meetingAttachments,
  ({ one }) => ({
    meetingMinute: one(meetingMinutes, {
...
export type InsertComplianceChecklistItem =
  typeof complianceChecklist.$inferInsert;
...
export type InsertComplianceEvidenceItem =
  typeof complianceEvidence.$inferInsert;
 ...
 */
export const companyLegalRepresentative = mysqlTable(
...
export type CompanyLegalRepresentative =
  typeof companyLegalRepresentative.$inferSelect;
export type InsertCompanyLegalRepresentative =
  typeof companyLegalRepresentative.$inferInsert;
...
export const companyDigitalSignature = mysqlTable("company_digital_signature", {
  ...
  certificadoUrl: varchar("certificado_url", { length: 512 }), // Certificado NOM-151
  certificadoKey: varchar("certificado_key", { length: 512 }),
  tipoFirmante: mysqlEnum("tipo_firmante", ["interno", "externo"])
    .default("interno")
    .notNull(),
  autorizadoPor: int("autorizado_por").references(() => users.id), // Admin que autorizó
  estadoAutorizacion: mysqlEnum("estado_autorizacion", [
    "pendiente",
    "autorizado",
    "rechazado",
  ])
...
export type CompanyDigitalSignature =
  typeof companyDigitalSignature.$inferSelect;
export type InsertCompanyDigitalSignature =
  typeof companyDigitalSignature.$inferInsert;
...
export const companySurveyReport = mysqlTable("company_survey_report", {
  ...
  guiaAplicada: mysqlEnum("guia_aplicada", [
    "guia-i",
    "guia-ii",
    "guia-iii",
  ]).notNull(),
  ...
  numeroTrabajadoresEncuestados: int(
    "numero_trabajadores_encuestados"
  ).notNull(),
  ...
  nivelRiesgoGeneral: mysqlEnum("nivel_riesgo_general", [
    "bajo",
    "medio",
    "alto",
    "muy_alto",
  ...
  nombreResponsableEvaluacion: varchar("nombre_responsable_evaluacion", {
    length: 255,
  }),
...
export const equalityPolicy = mysqlTable("equality_policy", {
  ...
  estado: mysqlEnum("estado", ["borrador", "vigente", "archivado"])
    .default("borrador")
    .notNull(),
  createdBy: int("created_by").references(() => users.id),
  createdAt: timestamp("created_at").defaultNow().notNull(),
...
export const equalitySalaryGap = mysqlTable("equality_salary_gap", {
  ...
  salarioPromedioMujeres: decimal("salario_promedio_mujeres", {
    precision: 10,
    scale: 2,
  }).notNull(),
  salarioPromedioHombres: decimal("salario_promedio_hombres", {
    precision: 10,
    scale: 2,
  }).notNull(),
  brechaPorcentual: decimal("brecha_porcentual", {
    precision: 5,
    scale: 2,
  }).notNull(), // %
  // Análisis
  nivelRiesgo: mysqlEnum("nivel_riesgo", ["bajo", "medio", "alto"])
    .default("bajo")
    .notNull(),
  observaciones: text("observaciones"),
 ...
 */
export const equalityAffirmativeActions = mysqlTable(
  "equality_affirmative_actions",
  {
    id: int("id").autoincrement().primaryKey(),
    titulo: varchar("titulo", { length: 255 }).notNull(),
    tipo: mysqlEnum("tipo", [
...
export type EqualityAffirmativeAction =
  typeof equalityAffirmativeActions.$inferSelect;
export type InsertEqualityAffirmativeAction =
  typeof equalityAffirmativeActions.$inferInsert;
...
export type InsertEqualityCommitteeMember =
  typeof equalityCommittee.$inferInsert;
...
export const nom035Policies = mysqlTable("nom035_policies", {
  ...
  representanteLegalId: int("representante_legal_id").references(
    () => companyLegalRepresentative.id
  ),
  pdfUrl: text("pdf_url"),
  activo: boolean("activo").default(true).notNull(),
  createdBy: int("created_by")
...
export const nom035PolicyVersions = mysqlTable("nom035_policy_versions", {
  ...
  policyId: int("policy_id")
    .references(() => nom035Policies.id, { onDelete: "cascade" })
    .notNull(),
...
export type InsertNom035PolicyVersion =
  typeof nom035PolicyVersions.$inferInsert;
...
export type InsertNom035EvidenceFolder =
  typeof nom035EvidenceFolder.$inferInsert;
 ...
 */
export const committeePositionAcceptances = mysqlTable(
  "committee_position_acceptances",
  {
    id: int("id").autoincrement().primaryKey(),
    committeeMemberId: int("committee_member_id")
      .references(() => committeeMembers.id)
      .notNull(),
    positionType: mysqlEnum("position_type", [
      "president",
      "secretary",
      "vocal",
      "alternate",
...
export type CommitteePositionAcceptance =
  typeof committeePositionAcceptances.$inferSelect;
export type InsertCommitteePositionAcceptance =
  typeof committeePositionAcceptances.$inferInsert;
...
export const investigationQuestionnaires = mysqlTable(
  "investigation_questionnaires",
  {
    id: int("id").autoincrement().primaryKey(),
    caseId: int("case_id")
      .references(() => nom035Cases.id)
      .notNull(),
    ...
    status: mysqlEnum("status", ["sent", "completed", "expired"])
      .default("sent")
      .notNull(),
...
export type InvestigationQuestionnaire =
  typeof investigationQuestionnaires.$inferSelect;
export type InsertInvestigationQuestionnaire =
  typeof investigationQuestionnaires.$inferInsert;
...
export const workplaceViolenceCases = mysqlTable("workplace_violence_cases", {
  ...
  accusedId: int("accused_id")
    .references(() => employees.id)
    .notNull(), // Persona acusada
  ...
  witnesses:
    json("witnesses").$type<Array<{ name: string; contact: string }>>(), // Testigos
  currentPhase: mysqlEnum("current_phase", [
    ...
    .default("recepcion")
    .notNull(),
  priority: mysqlEnum("priority", ["baja", "media", "alta", "critica"])
    .default("media")
    .notNull(),
  status: mysqlEnum("status", ["activo", "suspendido", "cerrado"])
    .default("activo")
    .notNull(),
  resolution: text("resolution"), // Resolución final del caso
...
export type InsertWorkplaceViolenceCase =
  typeof workplaceViolenceCases.$inferInsert;

// Protocol Steps - Seguimiento de fases del protocolo
export const protocolSteps = mysqlTable("protocol_steps", {
  id: int("id").autoincrement().primaryKey(),
  caseId: int("case_id")
    .references(() => workplaceViolenceCases.id)
    .notNull(),
  ...
  responsibleId: int("responsible_id")
    .references(() => users.id)
    .notNull(), // Responsable de la acción
...
export type CommitteeTrainingProgram =
  typeof committeeTrainingPrograms.$inferSelect;
export type InsertCommitteeTrainingProgram =
  typeof committeeTrainingPrograms.$inferInsert;
...
export const committeeTrainingSessions = mysqlTable("committee_sessions", {
  ...
  programId: int("program_id")
    .references(() => committeeTrainingPrograms.id)
    .notNull(),
...
export type CommitteeTrainingSession =
  typeof committeeTrainingSessions.$inferSelect;
export type InsertCommitteeTrainingSession =
  typeof committeeTrainingSessions.$inferInsert;
...
export const committeeTrainingAttendance = mysqlTable("committee_attendance", {
  ...
  sessionId: int("session_id")
    .references(() => committeeTrainingSessions.id)
    .notNull(),
  committeeMemberId: int("committee_member_id")
    .references(() => committeeMembers.id)
    .notNull(),
...
export type CommitteeTrainingAttendance =
  typeof committeeTrainingAttendance.$inferSelect;
export type InsertCommitteeTrainingAttendance =
  typeof committeeTrainingAttendance.$inferInsert;
...
export const nom035Responses = mysqlTable("nom035_responses", {
  ...
  employeeId: int("employee_id")
    .references(() => employees.id)
    .notNull(),
  surveyPeriodId: int("survey_period_id")
    .references(() => nom035SurveyPeriods.id)
    .notNull(),
  questionId: int("question_id")
    .references(() => nom035Questions.id)
    .notNull(),
...
export const nom035Results = mysqlTable("nom035_results", {
  ...
  globalRiskLevel: mysqlEnum("global_risk_level", [
    "nulo",
    "bajo",
    "medio",
    "alto",
...
export const alertHistory = mysqlTable("alert_history", {
  ...
  priority: mysqlEnum("priority", ["info", "warning", "critical"])
    .default("warning")
    .notNull(),
...
export const notificationHistory = mysqlTable("notification_history", {
  ...
  alertId: int("alert_id")
    ...
    .notNull(), // Referencia a la alerta
  alertType: mysqlEnum("alert_type", [
    "critical_cases",
    "low_coverage",
    "excellent_compliance",
...
export const jobOpenings = mysqlTable("job_openings", {
  ...
  employmentType: mysqlEnum("employment_type", [
    ...
    .default("permanent")
    .notNull(),
  status: mysqlEnum("status", ["draft", "open", "closed", "filled"])
    .default("draft")
    .notNull(),
  openDate: date("open_date"),
  closeDate: date("close_date"),
  minimumEducation: mysqlEnum("minimum_education", [
    "primaria",
    "secundaria",
    "preparatoria",
    "tecnico",
...
export const candidates = mysqlTable("candidates", {
  id: int("id").autoincrement().primaryKey(),
  jobOpeningId: int("job_opening_id")
  ...
  verificationAuthorized: boolean("verification_authorized")
    .default(false)
    .notNull(), // Autorización de verificación
...
export type InsertCandidateWorkHistory =
  typeof candidateWorkHistory.$inferInsert;
...
export const exitInterviewQuestions = mysqlTable("exit_interview_questions", {
  id: int("id").autoincrement().primaryKey(),
  questionText: text("question_text").notNull(),
  questionType: mysqlEnum("question_type", ["multiple_choice", "text"])
...
export type InsertExitInterviewQuestion =
  typeof exitInterviewQuestions.$inferInsert;

// Exit Interviews - Entrevistas de salida
export const exitInterviews = mysqlTable("exit_interviews", {
  id: int("id").autoincrement().primaryKey(),
  terminationId: int("termination_id")
...
export const exitInterviewResponses = mysqlTable("exit_interview_responses", {
  id: int("id").autoincrement().primaryKey(),
  exitInterviewId: int("exit_interview_id")
    .references(() => exitInterviews.id, { onDelete: "cascade" })
    .notNull(),
  questionId: int("question_id")
    .references(() => exitInterviewQuestions.id)
    .notNull(),
...
export type InsertExitInterviewResponse =
  typeof exitInterviewResponses.$inferInsert;
...
export const turnoverActionPlans = mysqlTable("turnover_action_plans", {
  ...
  // Estado del plan
  status: mysqlEnum("status", ["draft", "approved", "in_progress", "completed"])
    .default("draft")
    .notNull(),
...
export type InsertComplianceRequirement =
...
export const committeeMinutes = mysqlTable("committee_minutes", {
  ...
  meetingType: mysqlEnum("meeting_type", [
    ...
    .notNull()
    .default("ordinaria"),
  status: mysqlEnum("status", ["borrador", "finalizada", "archivada"])
    .notNull()
    .default("borrador"),
 ...
 */
export const committeeMinuteAttendees = mysqlTable(
  "committee_minute_attendees",
  {
    id: int("id").autoincrement().primaryKey(),
    minuteId: int("minute_id")
      .references(() => committeeMinutes.id)
      .notNull(),
...
export type CommitteeMinuteAttendee =
  typeof committeeMinuteAttendees.$inferSelect;
export type InsertCommitteeMinuteAttendee =
  typeof committeeMinuteAttendees.$inferInsert;

/**
 * Committee Minute Agenda Items - Orden del Día
 */
export const committeeMinuteAgendaItems = mysqlTable(
  "committee_minute_agenda_items",
  {
    id: int("id").autoincrement().primaryKey(),
    minuteId: int("minute_id")
      .references(() => committeeMinutes.id)
...
export type CommitteeMinuteAgendaItem =
  typeof committeeMinuteAgendaItems.$inferSelect;
export type InsertCommitteeMinuteAgendaItem =
  typeof committeeMinuteAgendaItems.$inferInsert;

/**
 * Committee Minute Agreements - Acuerdos de Minutas
 */
export const committeeMinuteAgreements = mysqlTable(
  "committee_minute_agreements",
  {
    id: int("id").autoincrement().primaryKey(),
    minuteId: int("minute_id")
      .references(() => committeeMinutes.id)
    ...
    status: mysqlEnum("status", [
      ...
      .notNull()
      .default("pendiente"),
    priority: mysqlEnum("priority", ["baja", "media", "alta", "urgente"])
      .notNull()
      .default("media"),
    notes: text("notes"), // Notas adicionales
    completedAt: timestamp("completed_at"),
...
export type CommitteeMinuteAgreement =
  typeof committeeMinuteAgreements.$inferSelect;
export type InsertCommitteeMinuteAgreement =
  typeof committeeMinuteAgreements.$inferInsert;
...
export type CommitteeMinuteHistoryEntry =
  typeof committeeMinuteHistory.$inferSelect;
export type InsertCommitteeMinuteHistoryEntry =
  typeof committeeMinuteHistory.$inferInsert;
...
export const examAnswers = mysqlTable("exam_answers", {
  ...
  questionId: int("question_id")
    .references(() => examQuestions.id)
    .notNull(),
  selectedOptionId: int("selected_option_id").references(
...
export const notificationTemplates = mysqlTable("notification_templates", {
  ...
  description: text("description"), // Descripción
  channel: mysqlEnum("channel", ["email", "sms", "both"])
    .notNull()
    .default("email"),
...
export const invoices = mysqlTable("invoices", {
  ...
  estado: mysqlEnum("estado", ["pendiente", "pagada", "vencida", "cancelada"])
    .notNull()
    .default("pendiente"),
...
export const purchaseOrders = mysqlTable("purchase_orders", {
  ...
  estado: mysqlEnum("estado", ["borrador", "enviada", "recibida", "cancelada"])
    .notNull()
    .default("borrador"),
  descripcion: text("descripcion"),
  archivoUrl: varchar("archivo_url", { length: 500 }),
...
export const expenseRequests = mysqlTable("expense_requests", {
  ...
  estado: mysqlEnum("estado", ["pendiente", "aprobada", "rechazada", "pagada"])
    .notNull()
    .default("pendiente"),
...
export const permissionChangeHistory = mysqlTable("permission_change_history", {
  ...
  userId: int("user_id")
    .references(() => users.id)
    .notNull(), // Usuario cuyo permiso fue modificado
  changedBy: int("changed_by")
    .references(() => users.id)
    .notNull(), // Usuario que realizó el cambio
...
export type PermissionChangeHistory =
  typeof permissionChangeHistory.$inferSelect;
export type InsertPermissionChangeHistory =
  typeof permissionChangeHistory.$inferInsert;
...
export type InsertSurveyAnonymousToken =
  typeof surveyAnonymousTokens.$inferInsert;
...
export const userNotificationPreferences = mysqlTable(
  "user_notification_preferences",
  {
    ...
    correctiveActionsEnabled: boolean("corrective_actions_enabled")
      .notNull()
      .default(true), // Acciones correctivas
    ...
    dailySummaryEnabled: boolean("daily_summary_enabled")
      .notNull()
      .default(false), // Resumen diario por correo
    dailySummaryTime: varchar("daily_summary_time", { length: 5 }).default(
      "09:00"
    ), // Hora del resumen (HH:mm)
...
export type InsertSkillsMatrixSnapshot =
  typeof skillsMatrixSnapshots.$inferInsert;

/**
 * Competency Regression Alerts
 * Tracks significant drops in employee competency levels
 */
export const competencyRegressionAlerts = mysqlTable(
  "competency_regression_alerts",
  {
    id: int("id").autoincrement().primaryKey(),
    employeeId: int("employee_id")
      .notNull()
    ...
    competencyId: int("competency_id")
      .notNull()
      .references(() => organizationalCompetencies.id),
...
export type CompetencyRegressionAlert =
  typeof competencyRegressionAlerts.$inferSelect;
export type InsertCompetencyRegressionAlert =
  typeof competencyRegressionAlerts.$inferInsert;
...
export type InsertRecognitionCategory =
  typeof recognitionCategories.$inferInsert;
...
export const recognitions = mysqlTable("recognitions", {
  ...
  categoryId: int("category_id")
    .notNull()
    .references(() => recognitionCategories.id),
...
export type InsertRecognitionReaction =
  typeof recognitionReactions.$inferInsert;
...
export type InsertNMX025ManualEvidence =
  typeof nmx025ManualEvidences.$inferInsert;
...
export const postCaseSurveys = mysqlTable("post_case_surveys", {
  ...
  status: mysqlEnum("status", ["pending", "sent", "completed", "expired"])
    .default("pending")
    .notNull(),
  sentAt: timestamp("sent_at"),
  completedAt: timestamp("completed_at"),
  ...
  surveyToken: varchar("survey_token", { length: 64 }),
...
export const rootCauseAnalysis = mysqlTable("root_cause_analysis", {
  ...
  departmentInsights: json("department_insights").$type<
    Record<
      string,
      {
        totalCases: number;
...
export const trainingAssignments = mysqlTable("training_assignments", {
  ...
  trainingId: int("training_id")
    .notNull()
    .references(() => committeeTrainings.id, { onDelete: "cascade" }),
  committeeMemberId: int("committee_member_id")
    .notNull()
    .references(() => users.id, { onDelete: "cascade" }),
...
export const trainingCertificates = mysqlTable("training_certificates", {
  ...
  certificateNumber: varchar("certificate_number", { length: 50 })
    .notNull()
    .unique(), // Número de certificado único
  ...
  verificationCode: varchar("verification_code", { length: 100 })
    .notNull()
    .unique(), // Código de verificación (UUID)
...
export type InsertTrainingCertificate =
  typeof trainingCertificates.$inferInsert;
...
export const recommendationsTracking = mysqlTable("recommendations_tracking", {
  ...
  analysisId: int("analysis_id")
    .notNull()
    .references(() => rootCauseAnalysis.id, { onDelete: "cascade" }),
  ...
  targetDepartmentId: int("target_department_id").references(
    () => departments.id,
    { onDelete: "set null" }
  ),
  ...
  reductionPercentage: decimal("reduction_percentage", {
    precision: 5,
    scale: 2,
  }), // % de reducción
...
export type RecommendationTracking =
  typeof recommendationsTracking.$inferSelect;
export type InsertRecommendationTracking =
  typeof recommendationsTracking.$inferInsert;
...
export const trainingEvaluations = mysqlTable("training_evaluations", {
  ...
  wouldRecommend: mysqlEnum("would_recommend", [
    "yes",
    "no",
    "maybe",
  ]).notNull(),
...
export const intelligentAlerts = mysqlTable("intelligent_alerts", {
  ...
  // Estado de la alerta
  status: mysqlEnum("status", ["active", "resolved", "dismissed"])
    .notNull()
    .default("active"),
...
export const trainingCosts = mysqlTable("training_costs", {
  ...
  trainingId: int("training_id")
    .notNull()
    .references(() => committeeTrainings.id, { onDelete: "cascade" }),
  instructorCost: decimal("instructor_cost", { precision: 10, scale: 2 })
    .notNull()
    .default("0.00"),
  materialsCost: decimal("materials_cost", { precision: 10, scale: 2 })
    .notNull()
    .default("0.00"),
  facilitiesCost: decimal("facilities_cost", { precision: 10, scale: 2 })
    .notNull()
    .default("0.00"),
  laborHoursCost: decimal("labor_hours_cost", { precision: 10, scale: 2 })
    .notNull()
    .default("0.00"), // Costo de horas laborales de participantes
...
export const sectorBenchmarks = mysqlTable("sector_benchmarks", {
  ...
  sectorId: int("sector_id")
    .notNull()
    .references(() => industrySectors.id, { onDelete: "cascade" }),
...
export const correctiveActionPlans = mysqlTable("corrective_action_plans", {
  ...
  // Origen del plan
  originType: mysqlEnum("origin_type", [
    "root_cause_analysis",
    "intelligent_alert",
    "manual_case",
    "recommendation",
...
export const actionEvidences = mysqlTable("action_evidences", {
  ...
  planId: int("plan_id")
    .notNull()
    .references(() => correctiveActionPlans.id, { onDelete: "cascade" }),
...
export const interventionImpactAnalysis = mysqlTable(
  "intervention_impact_analysis",
  {
    id: int("id").primaryKey().autoincrement(),
    interventionType: mysqlEnum("intervention_type", [
      "training",
      "policy_change",
    ...
    climateScoreBefore: decimal("climate_score_before", {
      precision: 3,
      scale: 2,
    }), // 0-5
    satisfactionScoreBefore: decimal("satisfaction_score_before", {
      precision: 3,
      scale: 2,
    }), // 0-5
    ...
    climateScoreAfter: decimal("climate_score_after", {
      precision: 3,
      scale: 2,
    }), // 0-5
    satisfactionScoreAfter: decimal("satisfaction_score_after", {
      precision: 3,
      scale: 2,
    }), // 0-5
    ...
    // Métricas calculadas
    caseReductionPercentage: decimal("case_reduction_percentage", {
      precision: 5,
      scale: 2,
    }),
    resolutionTimeImprovement: decimal("resolution_time_improvement", {
      precision: 5,
      scale: 2,
    }),
    climateScoreImprovement: decimal("climate_score_improvement", {
      precision: 5,
      scale: 2,
    }),
    satisfactionScoreImprovement: decimal("satisfaction_score_improvement", {
      precision: 5,
      scale: 2,
    }),
...
export const sharedReportsLog = mysqlTable("shared_reports_log", {
  ...
  shareChannel: mysqlEnum("share_channel", [
    "email",
    "linkedin",
    "twitter",
    "whatsapp",
...
export const reportCache = mysqlTable("report_cache", {
  ...
  reportType: mysqlEnum("report_type", [
    "intervention_impact_pdf",
    "intervention_impact_excel",
    "shared_reports_excel",
  ]).notNull(),
...
export const bulkReassignments = mysqlTable("bulk_reassignments", {
  ...
  targetDepartmentName: varchar("target_department_name", {
    length: 255,
  }).notNull(),
...
export const predictiveTurnoverAlerts = mysqlTable(
  "predictive_turnover_alerts",
  {
    id: int("id").primaryKey().autoincrement(),
    ...
    // Predicción
    predictedTurnoverRate: decimal("predicted_turnover_rate", {
      precision: 5,
      scale: 2,
    }), // Porcentaje estimado de rotación
...
export const predictiveAlgorithmConfig = mysqlTable(
  "predictive_algorithm_config",
  {
    id: int("id").primaryKey().autoincrement(),
...
export const predictionHistory = mysqlTable("prediction_history", {
  ...
  predictedTurnoverRate: decimal("predicted_turnover_rate", {
    precision: 5,
    scale: 2,
  }), // Tasa de rotación predicha (%)

  // Datos reales observados (se actualizan después de 3 meses)
  actualTurnoverRate: decimal("actual_turnover_rate", {
    precision: 5,
    scale: 2,
  }), // Tasa de rotación real (%)
...
export const departmentThresholds = mysqlTable("department_thresholds", {
  ...
  avgResolutionDaysThreshold: int("avg_resolution_days_threshold")
    .default(30)
    .notNull(), // Días promedio de resolución
...
export type InsertDepartmentThreshold =
  typeof departmentThresholds.$inferInsert;
...
export type InsertReportConfiguration =
  typeof reportConfigurations.$inferInsert;
...
export type ExecutiveReportHistory =
  typeof executiveReportsHistory.$inferSelect;
export type InsertExecutiveReportHistory =
  typeof executiveReportsHistory.$inferInsert;

// Relations para executiveReportsHistory
export const executiveReportsHistoryRelations = relations(
  executiveReportsHistory,
  ({ one }) => ({
    generator: one(users, {
...
export type EmployeeTurnoverHistory =
  typeof employeeTurnoverHistory.$inferSelect;
export type InsertEmployeeTurnoverHistory =
  typeof employeeTurnoverHistory.$inferInsert;
...
export const modelThresholdsRelations = relations(
  modelThresholds,
  ({ one }) => ({
    creator: one(users, {
...
export const modelPerformanceAlerts = mysqlTable("model_performance_alerts", {
  ...
  thresholdValue: decimal("threshold_value", {
    precision: 5,
    scale: 2,
  }).notNull(), // Umbral crítico configurado
...
export type InsertModelPerformanceAlert =
  typeof modelPerformanceAlerts.$inferInsert;
...
export type InsertThresholdExperiment =
  typeof thresholdExperiments.$inferInsert;
...
export type InsertModelRetrainingHistory =
  typeof modelRetrainingHistory.$inferInsert;
...
export const retentionInterventions = mysqlTable("retention_interventions", {
  ...
  turnoverProbabilityBefore: decimal("turnover_probability_before", {
    precision: 5,
    scale: 2,
  }), // Probabilidad de rotación antes (0-100)

  // Métricas después de la intervención
  riskScoreAfter: decimal("risk_score_after", { precision: 5, scale: 2 }), // Riesgo de rotación después (0-100)
  turnoverProbabilityAfter: decimal("turnover_probability_after", {
    precision: 5,
    scale: 2,
  }), // Probabilidad de rotación después (0-100)
...
export type InsertRetentionIntervention =
  typeof retentionInterventions.$inferInsert;
...
export const payrollData = mysqlTable("payroll_data", {
  ...
  lastRaisePercentage: decimal("last_raise_percentage", {
    precision: 5,
    scale: 2,
  ...
  salaryGapPercentage: decimal("salary_gap_percentage", {
    precision: 5,
    scale: 2,
  }), // Brecha salarial (%)
...
export const compensationReportsHistory = mysqlTable(
  "compensation_reports_history",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    totalAdjustmentCost: decimal("total_adjustment_cost", {
      precision: 12,
      scale: 2,
    }),
...
export type CompensationReportsHistory =
  typeof compensationReportsHistory.$inferSelect;
export type InsertCompensationReportsHistory =
  typeof compensationReportsHistory.$inferInsert;
...
export const salaryHistory = mysqlTable("salary_history", {
  ...
  adjustmentPercentage: decimal("adjustment_percentage", {
    precision: 5,
    scale: 2,
  }),
...
export const externalOfferRiskAlerts = mysqlTable(
  "external_offer_risk_alerts",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    turnoverProbability: decimal("turnover_probability", {
      precision: 5,
      scale: 2,
    }),
...
export type ExternalOfferRiskAlerts =
  typeof externalOfferRiskAlerts.$inferSelect;
export type InsertExternalOfferRiskAlerts =
  typeof externalOfferRiskAlerts.$inferInsert;

// Escenarios de planificación presupuestaria de ajustes salariales
export const budgetAdjustmentScenarios = mysqlTable(
  "budget_adjustment_scenarios",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    averageIncreasePercentage: decimal("average_increase_percentage", {
      precision: 5,
      scale: 2,
    }),
    highRiskEmployeesCovered: int("high_risk_employees_covered").default(0),
    estimatedRetentionRate: decimal("estimated_retention_rate", {
      precision: 5,
      scale: 2,
    }),

    // ROI proyectado
    estimatedTurnoverCostSavings: decimal("estimated_turnover_cost_savings", {
      precision: 12,
      scale: 2,
    }),
...
export type BudgetAdjustmentScenarios =
  typeof budgetAdjustmentScenarios.$inferSelect;
export type InsertBudgetAdjustmentScenarios =
  typeof budgetAdjustmentScenarios.$inferInsert;
...
export const salaryEquityAnalysis = mysqlTable("salary_equity_analysis", {
  ...
  // Análisis por Género
  maleAverageSalary: decimal("male_average_salary", {
    precision: 12,
    scale: 2,
  }),
  femaleAverageSalary: decimal("female_average_salary", {
    precision: 12,
    scale: 2,
  }),
  genderPayGapPercentage: decimal("gender_pay_gap_percentage", {
    precision: 5,
    scale: 2,
  ...
  // Análisis por Edad
  ageGroupAnalysis: json("age_group_analysis").$type<
    Array<{
  ...
  tenureGroupAnalysis: json("tenure_group_analysis").$type<
    Array<{
  ...
  criticalCases: json("critical_cases").$type<
    Array<{
      employeeId: number;
      employeeName: string;
      department: string;
  ...
  nmxComplianceStatus: varchar("nmx_compliance_status", { length: 50 }).default(
    "non_compliant"
...
export type InsertSalaryEquityAnalysis =
  typeof salaryEquityAnalysis.$inferInsert;
...
export const equityReportsHistory = mysqlTable("equity_reports_history", {
  ...
  analysisId: int("analysis_id")
    .notNull()
    .references(() => salaryEquityAnalysis.id),
...
export type InsertEquityReportsHistory =
  typeof equityReportsHistory.$inferInsert;
...
export const organizationalClimateSurveys = mysqlTable(
  "organizational_climate_surveys",
  {
    id: int("id").autoincrement().primaryKey(),
    title: varchar("title", { length: 255 }).notNull(),
    description: text("description"),
...
export type OrganizationalClimateSurvey =
  typeof organizationalClimateSurveys.$inferSelect;
export type InsertOrganizationalClimateSurvey =
  typeof organizationalClimateSurveys.$inferInsert;
...
export const climateSurveyResponses = mysqlTable("climate_survey_responses", {
  ...
  surveyId: int("survey_id")
    .notNull()
    .references(() => organizationalClimateSurveys.id),
  employeeId: int("employee_id").notNull(),
...
export type InsertClimateSurveyResponse =
  typeof climateSurveyResponses.$inferInsert;
...
export const climateAnalysis = mysqlTable("climate_analysis", {
  ...
  // Áreas críticas
  criticalAreas: json("critical_areas").$type<
    Array<{
      dimension: string;
      score: number;
...
export const employeeCareerPlans = mysqlTable("employee_career_plans", {
  ...
  competencyGaps: json("competency_gaps").$type<
    Array<{
      competencyId: number;
      competencyName: string;
      currentLevel: number;
  ...
  projectedVacancies: json("projected_vacancies").$type<
    Array<{
      positionId: number;
      positionName: string;
...
export const surveyEmployeeTokens = mysqlTable("survey_employee_tokens", {
  ...
  employeeId: int("employee_id")
    .notNull()
    .references(() => employees.id, { onDelete: "cascade" }), // Empleado asociado
  curp: varchar("curp", { length: 18 }).notNull(), // CURP para autenticación
  surveyPeriodId: int("survey_period_id")
    .notNull()
    .references(() => surveyPeriods.id, { onDelete: "cascade" }), // Período de encuesta
  surveyType: varchar("survey_type", { length: 50 }).notNull(), // 'guia_i', 'guia_ii', 'guia_iii'
  ...
  generatedBy: int("generated_by")
    .notNull()
    .references(() => users.id), // Admin que generó el token
  notes: text("notes"), // Notas opcionales
  createdAt: timestamp("created_at").defaultNow().notNull(),
});

export type SurveyEmployeeToken = typeof surveyEmployeeTokens.$inferSelect;
export type InsertSurveyEmployeeToken =
  typeof surveyEmployeeTokens.$inferInsert;
...
export const committeeAnnualReports = mysqlTable("committee_annual_reports", {
  ...
  folioVersion: varchar("folio_version", { length: 10 })
    .notNull()
    .default("1.0"), // Versión del formato
...
export type InsertCommitteeAnnualReport =
  typeof committeeAnnualReports.$inferInsert;
...
export type CommitteeOperatingRules =
  typeof committeeOperatingRules.$inferSelect;
export type InsertCommitteeOperatingRules =
  typeof committeeOperatingRules.$inferInsert;
 ...
 */
export const committeeOperatingRulesVersions = mysqlTable(
  "committee_operating_rules_versions",
  {
    id: int("id").autoincrement().primaryKey(),

    // Referencia a la base de funcionamiento principal
    operatingRuleId: int("operating_rule_id")
      .notNull()
      .references(() => committeeOperatingRules.id, { onDelete: "cascade" }),
...
export type CommitteeOperatingRulesVersion =
  typeof committeeOperatingRulesVersions.$inferSelect;
export type InsertCommitteeOperatingRulesVersion =
  typeof committeeOperatingRulesVersions.$inferInsert;
...
export const operatingRulesApprovals = mysqlTable("operating_rules_approvals", {
  ...
  approverId: int("approver_id")
    .notNull()
    .references(() => users.id),
  approverRole: mysqlEnum("approver_role", [
    "president",
    "secretary",
    "vocal",
    "other",
  ]).notNull(),
  approverRoleDescription: varchar("approver_role_description", {
    length: 100,
  }), // Descripción personalizada del rol

  // Estado de la aprobación
  status: mysqlEnum("status", ["pending", "signed", "rejected"])
    .default("pending")
    .notNull(),

  // Firma digital
  signatureData: text("signature_data"), // Datos de la firma digital en base64
  signatureMethod: mysqlEnum("signature_method", [
    "digital_pad",
    "uploaded",
    "certificate",
  ]).default("digital_pad"),
...
export type OperatingRulesApproval =
  typeof operatingRulesApprovals.$inferSelect;
export type InsertOperatingRulesApproval =
  typeof operatingRulesApprovals.$inferInsert;
...
export const operatingRulesTemplates = mysqlTable("operating_rules_templates", {
  ...
  name: varchar("name", { length: 200 }).notNull(),
  description: text("description"),
  companySize: mysqlEnum("company_size", [
    "small",
    "medium",
    "large",
  ]).notNull(), // Hasta 15, 16-50, >50 empleados
...
export type OperatingRulesTemplate =
  typeof operatingRulesTemplates.$inferSelect;
export type InsertOperatingRulesTemplate =
  typeof operatingRulesTemplates.$inferInsert;
...
export const approvalCalendarEvents = mysqlTable("approval_calendar_events", {
  ...
  approvalId: int("approval_id")
    .notNull()
    .references(() => operatingRulesApprovals.id, { onDelete: "cascade" }),
...
export type InsertApprovalCalendarEvent =
  typeof approvalCalendarEvents.$inferInsert;
...
export const evaluation360Assignments = mysqlTable(
  "evaluation_360_assignments",
  {
    id: int("id").autoincrement().primaryKey(),
...
export type Evaluation360Assignment =
  typeof evaluation360Assignments.$inferSelect;
export type InsertEvaluation360Assignment =
  typeof evaluation360Assignments.$inferInsert;
...
export const evaluation360Evaluators = mysqlTable("evaluation_360_evaluators", {
  ...
  evaluatorType: mysqlEnum("evaluator_type", [
    "self",
    "peer",
    "supervisor",
    "subordinate",
...
export type Evaluation360Evaluator =
  typeof evaluation360Evaluators.$inferSelect;
export type InsertEvaluation360Evaluator =
  typeof evaluation360Evaluators.$inferInsert;
...
export const evaluation360Responses = mysqlTable("evaluation_360_responses", {
  ...
  competencyType: mysqlEnum("competency_type", [
    "technical",
    "soft_skill",
    "leadership",
    "organizational",
...
export type InsertEvaluation360Response =
  typeof evaluation360Responses.$inferInsert;
...
export const evaluation360Results = mysqlTable("evaluation_360_results", {
  ...
  subordinateAvgScore: decimal("subordinate_avg_score", {
    precision: 3,
    scale: 2,
  }),
  overallAvgScore: decimal("overall_avg_score", {
    precision: 3,
    scale: 2,
  }).notNull(),
  gapSelfVsOthers: decimal("gap_self_vs_others", { precision: 3, scale: 2 }),
  gapSupervisorVsPeers: decimal("gap_supervisor_vs_peers", {
    precision: 3,
    scale: 2,
  }),
...
export type InsertEvaluation360Result =
  typeof evaluation360Results.$inferInsert;

export const evaluation360DevelopmentPlans = mysqlTable(
  "evaluation_360_development_plans",
  {
    id: int("id").autoincrement().primaryKey(),
    assignmentId: int("assignment_id").notNull(),
    employeeId: int("employee_id").notNull(),
...
export type Evaluation360DevelopmentPlan =
  typeof evaluation360DevelopmentPlans.$inferSelect;
export type InsertEvaluation360DevelopmentPlan =
  typeof evaluation360DevelopmentPlans.$inferInsert;
...
export const caseInvestigationDocs = mysqlTable("case_investigation_docs", {
  ...
  titulo: varchar("titulo", { length: 500 })
    .notNull()
    .default("Investigación de caso"),
  version: varchar("version", { length: 20 }).notNull().default("1.0"),
  estado: mysqlEnum("estado", ["borrador", "final", "aprobado"])
    .notNull()
    .default("borrador"),
...
export type InsertCaseInvestigationDoc =
  typeof caseInvestigationDocs.$inferInsert;
...
export const dictamenDocs = mysqlTable("dictamen_docs", {
  ...
  nivelRiesgoGlobal: mysqlEnum("nivel_riesgo_global", [
    "ausente",
    "bajo",
    "medio",
    "alto",
...
export type PsychometricAssessment =
  typeof psychometricAssessments.$inferSelect;
export type InsertPsychometricAssessment =
  typeof psychometricAssessments.$inferInsert;
...
export const bugReports = mysqlTable("bug_reports", {
  ...
  severity: mysqlEnum("severity", ["critico", "alto", "medio", "bajo"])
    .default("medio")
    .notNull(),
  status: mysqlEnum("status", [
    "pendiente",
...
export const featureRequests = mysqlTable("feature_requests", {
  ...
  priority: mysqlEnum("priority", ["baja", "normal", "alta", "critica"])
    .default("normal")
    .notNull(),
  status: mysqlEnum("status", [
    "pendiente",
...
export const annualTrainingPlanItems = mysqlTable(
  "annual_training_plan_items",
  {
    id: int("id").primaryKey().autoincrement(),
    planId: int("plan_id")
      .notNull()
      .references(() => annualTrainingPlans.id, { onDelete: "cascade" }),
    ...
    dncId: int("dnc_id").references(() => trainingNeeds.id, {
      onDelete: "set null",
    }),
    createdAt: timestamp("created_at").defaultNow().notNull(),
    updatedAt: timestamp("updated_at").defaultNow().onUpdateNow().notNull(),
...
export type AnnualTrainingPlanItem =
  typeof annualTrainingPlanItems.$inferSelect;
export type InsertAnnualTrainingPlanItem =
  typeof annualTrainingPlanItems.$inferInsert;
...
export const jobExecutionLog = mysqlTable("job_execution_log", {
  ...
  status: mysqlEnum("status", ["success", "error", "skipped"])
    .notNull()
    .default("success"),
...
export const minuteDispatches = mysqlTable("minute_dispatches", {
  ...
  status: mysqlEnum("status", ["sent", "read", "bounced"])
    .default("sent")
    .notNull(),
  notes: text("notes"),
...
export const nom035Plans = mysqlTable("nom035_plans", {
  id: int("id").autoincrement().primaryKey(),
  // Nivel de aplicación
  nivelAplicacion: mysqlEnum("nivel_aplicacion", [
    "organizacional",
    "grupal",
    "individual",
  ]).notNull(),
  ...
  // Estado
  status: mysqlEnum("status", ["borrador", "activo", "cerrado", "archivado"])
    .default("activo")
    .notNull(),
  // Firmas
...
export const nom035Actions = mysqlTable("nom035_actions", {
  ...
  prioridad: mysqlEnum("prioridad", ["alta", "media", "baja"])
    ...
    .notNull(),
  // Notificaciones
  notificacion7DiasEnviada: boolean("notificacion_7dias_enviada")
    .default(false)
    .notNull(),
  notificacionVencimientoEnviada: boolean("notificacion_vencimiento_enviada")
    .default(false)
    .notNull(),
  // Soft delete
  isActive: boolean("is_active").default(true).notNull(),
...
export type InsertNom035EvidenceToken =
  typeof nom035EvidenceTokens.$inferInsert;
...
export type InsertNom035CommitteeMember =
  typeof nom035CommitteeMembers.$inferInsert;
...
export type Nom035CommitteeMeeting =
  typeof nom035CommitteeMeetings.$inferSelect;
export type InsertNom035CommitteeMeeting =
  typeof nom035CommitteeMeetings.$inferInsert;

/**
 * Acuerdos derivados de las reuniones del Comité NOM-035.
 */
export const nom035CommitteeAgreements = mysqlTable(
  "nom035_committee_agreements",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    status: mysqlEnum("status", [
      ...
      .notNull()
      .default("pendiente"),
    priority: mysqlEnum("priority", ["alta", "media", "baja"])
      .notNull()
      .default("media"),
    completedAt: timestamp("completed_at"),
...
export type Nom035CommitteeAgreement =
  typeof nom035CommitteeAgreements.$inferSelect;
export type InsertNom035CommitteeAgreement =
  typeof nom035CommitteeAgreements.$inferInsert;
...
export type Nom035MeetingSignature =
  typeof nom035MeetingSignatures.$inferSelect;
export type InsertNom035MeetingSignature =
  typeof nom035MeetingSignatures.$inferInsert;
...
export type InsertEmployeePortalToken =
  typeof employeePortalTokens.$inferInsert;
...
export const stpsInspectionItems = mysqlTable("stps_inspection_items", {
  ...
  status: mysqlEnum("status", ["cumple", "no_cumple", "parcial", "na"])
    .default("na")
    .notNull(),
  observations: text("observations"),
...
export const internalNotices = mysqlTable("internal_notices", {
  ...
  noticeType: mysqlEnum("notice_type", [
    "aviso",
    "comunicado",
    "circular",
    "urgente",
...
export type InsertNoticeAcknowledgment =
  typeof noticeAcknowledgments.$inferInsert;
...
export const anonymousSuggestions = mysqlTable("anonymous_suggestions", {
  ...
  category: mysqlEnum("category", [
    ...
    .notNull(),
  content: text("content").notNull(),
  status: mysqlEnum("status", ["nueva", "en_revision", "atendida", "archivada"])
    .default("nueva")
    .notNull(),
...
export type InsertAnonymousSuggestion =
  typeof anonymousSuggestions.$inferInsert;
...
export const dc3Records = mysqlTable("dc3_records", {
  ...
  workerOccupationCnoDesc: varchar("worker_occupation_cno_desc", {
    length: 255,
  }),
  ...
  // ── Metadatos ─────────────────────────────────────────────────────────────
  status: mysqlEnum("status", ["draft", "issued", "cancelled"])
    .default("draft")
    .notNull(),
