...
- [x] Crear router permissionAudit.ts con procedures de consulta
- [x] Crear página PermissionAudit.tsx para visualizar historial
- [x] Agregar filtros por usuario, tipo de cambio, fecha
- [x] Implementar paginación en historial
### Exportación Excel/PDF en RolesPermissions.tsx
- [x] Agregar botón "Exportar Excel" en RolesPermissions.tsx
- [x] Implementar función exportToExcel() con matriz de permisos
- [x] Agregar botón "Exportar PDF" en RolesPermissions.tsx
- [x] Implementar función exportToPDF() con window.print()misos
- [ ] Proteger botones con ProtectedButton (can_export)

### Exportación Excel/PDF en CustomPermissions.tsx
- [x] Agregar botón "Exportar Excel" en CustomPermissions.tsx
- [x] Implementar función exportToExcel() con usuarios y permisos personalizados
- [x] Agregar botón "Exportar PDF" en CustomPermissions.tsx
- [x] Implementar función exportToPDF() con window.print()misos personalizados
- [ ] Proteger botones con ProtectedButton (can_export)
