...
-- FASE 201: Datos de Prueba Corregidos para Validación Funcional

-- ============================================
-- 1. INSERTAR EMPLEADOS DE PRUEBA (10 registros)
-- ============================================

INSERT INTO employees (firstName, lastName, email, phone, curp, employeeNumber, departmentId, positionId, hireDate, createdAt, updatedAt) VALUES
...
INSERT INTO assessments (title, description, passing_score, time_limit, max_attempts, status, created_by, created_at, updated_at) VALUES
('Evaluación de Capacitación NOM-035 Básica', 'Evaluación sobre conceptos básicos de la NOM-035-STPS-2018', 70, 30, 3, 'active', 1, NOW(), NOW()),
('Evaluación de Prevención de Riesgos Psicosociales', 'Evaluación sobre identificación y prevención de factores de riesgo', 75, 45, 3, 'active', 1, NOW(), NOW()),
('Evaluación de Protocolo de Violencia Laboral', 'Evaluación sobre el protocolo de atención a casos de violencia laboral', 80, 25, 3, 'active', 1, NOW(), NOW()),
('Evaluación de Comité de Seguridad y Salud', 'Evaluación para miembros del comité de seguridad y salud en el trabajo', 70, 40, 3, 'active', 1, NOW(), NOW()),
('Evaluación de Primeros Auxilios Psicológicos', 'Evaluación sobre técnicas de primeros auxilios psicológicos en el trabajo', 75, 35, 3, 'active', 1, NOW(), NOW());
...
INSERT INTO exam_questions (assessment_id, question_text, question_type, points, order_index, created_at, updated_at) VALUES
...
INSERT INTO exam_question_options (question_id, option_text, is_correct, order_index, created_at) VALUES
(1, 'Identificar, analizar y prevenir los factores de riesgo psicosocial', 1, 1, NOW()),
(1, 'Aumentar la productividad de los trabajadores', 0, 2, NOW()),
(1, 'Reducir los costos operativos de la empresa', 0, 3, NOW()),
(1, 'Mejorar las relaciones laborales entre empleados', 0, 4, NOW());

-- Opciones para pregunta 2 (Evaluación 1)
INSERT INTO exam_question_options (question_id, option_text, is_correct, order_index, created_at) VALUES
(2, 'Condiciones del ambiente de trabajo que pueden causar estrés o daño psicológico', 1, 1, NOW()),
(2, 'Factores físicos que afectan la salud de los trabajadores', 0, 2, NOW()),
(2, 'Riesgos de accidentes en el lugar de trabajo', 0, 3, NOW()),
(2, 'Condiciones económicas de la empresa', 0, 4, NOW());

-- Opciones para pregunta 3 (Evaluación 1)
INSERT INTO exam_question_options (question_id, option_text, is_correct, order_index, created_at) VALUES
(3, '8 numerales', 1, 1, NOW()),
(3, '5 numerales', 0, 2, NOW()),
(3, '10 numerales', 0, 3, NOW()),
(3, '12 numerales', 0, 4, NOW());

-- Opciones para pregunta 4 (Evaluación 1)
INSERT INTO exam_question_options (question_id, option_text, is_correct, order_index, created_at) VALUES
(4, 'Todos los centros de trabajo en México', 1, 1, NOW()),
(4, 'Solo empresas con más de 100 trabajadores', 0, 2, NOW()),
(4, 'Solo empresas del sector industrial', 0, 3, NOW()),
(4, 'Solo empresas del sector público', 0, 4, NOW());

-- ============================================
-- 5. INSERTAR PLANTILLAS DE NOTIFICACIONES (5 registros)
-- ============================================

INSERT INTO notification_templates (code, name, description, channel, email_subject, email_body, is_active, created_at, updated_at) VALUES
('CERT_RENEWAL', 'Renovación de Certificado Próxima', 'Recordatorio de renovación de certificado de capacitación', 'email', 'Recordatorio: Renovación de Certificado de Capacitación', 'Estimado/a {{nombre}},\n\nLe recordamos que su certificado de capacitación "{{curso}}" vence el {{fechaVencimiento}}.\n\nPor favor, programe su renovación con anticipación.\n\nSaludos cordiales,\nComité de Seguridad y Salud', 1, NOW(), NOW()),
('NEW_COURSE', 'Nuevo Curso Disponible', 'Notificación de nuevo curso de capacitación disponible', 'email', 'Nuevo Curso de Capacitación Disponible', 'Estimado/a {{nombre}},\n\nTenemos el gusto de informarle que el curso "{{curso}}" ya está disponible.\n\nDuración: {{duracion}} minutos\nFecha límite: {{fechaLimite}}\n\nSaludos cordiales,\nComité de Seguridad y Salud', 1, NOW(), NOW()),
('EXAM_PENDING', 'Evaluación Pendiente', 'Recordatorio de evaluación pendiente', 'email', 'Recordatorio: Evaluación Pendiente', 'Estimado/a {{nombre}},\n\nTiene una evaluación pendiente: "{{evaluacion}}".\n\nFecha límite: {{fechaLimite}}\n\nPor favor, complete la evaluación a la brevedad.\n\nSaludos cordiales,\nComité de Seguridad y Salud', 1, NOW(), NOW()),
('CERT_GENERATED', 'Certificado Generado', 'Notificación de certificado de capacitación generado', 'email', 'Su Certificado de Capacitación ha sido Generado', 'Estimado/a {{nombre}},\n\n¡Felicidades! Su certificado de capacitación "{{curso}}" ha sido generado exitosamente.\n\nFolio: {{folio}}\nFecha de emisión: {{fechaEmision}}\n\nPuede descargarlo desde la plataforma.\n\nSaludos cordiales,\nComité de Seguridad y Salud', 1, NOW(), NOW()),
('COMMITTEE_MEETING', 'Convocatoria a Reunión del Comité', 'Convocatoria a reunión del comité de seguridad y salud', 'email', 'Convocatoria: Reunión del Comité de Seguridad y Salud', 'Estimado/a {{nombre}},\n\nPor medio de la presente, se le convoca a la reunión del Comité de Seguridad y Salud.\n\nFecha: {{fecha}}\nHora: {{hora}}\nLugar: {{lugar}}\n\nAgenda:\n{{agenda}}\n\nSaludos cordiales,\nComité de Seguridad y Salud', 1, NOW(), NOW());
...
-- - 16 opciones de respuesta (4 preguntas completas)
