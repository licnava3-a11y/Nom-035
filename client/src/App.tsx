  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path={"/committee/minute-recipients"}>
          <DashboardLayout>
            <Suspense fallback={<PageLoader />}>
              <MinuteRecipients />
            </Suspense>
        ...
        <Route path={"/committee/minute-recipients/:id/history"}>
          <DashboardLayout>
            <Suspense fallback={<PageLoader />}>
              <MinuteRecipientHistory />
            </Suspense>
          </DashboardLayout>
        </Route>
        <Route path={"/committee/dispatches"}>
          <DashboardLayout>
            <Suspense fallback={<PageLoader />}>
              <DispatchesPanel />
            </Suspense>
