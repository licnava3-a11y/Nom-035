...
export const ERROR_MESSAGES: Record<string, ErrorMessage> = {
  ...
  'NETWORK_TIMEOUT': {
    ...
    description: 'El servidor tardó demasiado en responder. Verifica tu conexión a internet e intenta nuevamente.',
    action: 'Reintentar',
    severity: 'warning'
  },
  'NETWORK_ERROR': {
  ...
  'SERVER_UNAVAILABLE': {
    ...
    description: 'El servidor está temporalmente fuera de servicio. Por favor intenta más tarde.',
  ...
  'VALIDATION_REQUIRED_FIELD': {
    ...
    description: 'Por favor completa todos los campos marcados con asterisco (*) antes de continuar.',
    action: 'Revisar formulario',
    severity: 'warning'
  },
  'VALIDATION_INVALID_FORMAT': {
    title: 'Formato inválido',
    description: 'Uno o más campos no tienen el formato correcto. Revisa los campos marcados en rojo.',
    action: 'Corregir formato',
    severity: 'warning'
  },
  'VALIDATION_DUPLICATE': {
    title: 'Registro duplicado',
    description: 'Ya existe un registro con estos datos. Por favor verifica la información ingresada.',
    action: 'Verificar datos',
    severity: 'warning'
  },
  'VALIDATION_INVALID_EMAIL': {
    title: 'Correo electrónico inválido',
    description: 'El formato del correo electrónico no es válido. Ejemplo: usuario@ejemplo.com',
    action: 'Corregir email',
    severity: 'warning'
  },
  'VALIDATION_INVALID_DATE': {
    title: 'Fecha inválida',
    description: 'La fecha ingresada no es válida o está fuera del rango permitido.',
  ...
  'BUSINESS_RULE_VIOLATION': {
    ...
    description: 'La operación no se puede completar porque viola una regla del sistema.',
    action: 'Revisar datos',
    severity: 'error'
  },
  'INCONSISTENT_STATE': {
    title: 'Estado inconsistente',
    description: 'El estado actual del registro no permite esta operación. Por favor recarga la página.',
    action: 'Recargar página',
    severity: 'warning'
  },
  'DEADLINE_EXPIRED': {
    title: 'Fecha límite vencida',
    description: 'No se puede realizar esta acción porque la fecha límite ha expirado.',
    action: 'Contactar responsable',
    severity: 'error'
  },
  'APPROVAL_ALREADY_EXISTS': {
    title: 'Aprobación ya solicitada',
    description: 'Ya existe una solicitud de aprobación pendiente para este documento.',
  ...
  'CANNOT_DELETE_ACTIVE': {
    ...
    description: 'No se pueden eliminar registros activos. Primero debes desactivarlos o archivarlos.',
  ...
  'FILE_TOO_LARGE': {
    ...
    description: 'El archivo excede el tamaño máximo permitido de 10MB. Por favor selecciona un archivo más pequeño.',
    action: 'Seleccionar otro archivo',
    severity: 'warning'
  },
  'INVALID_FILE_TYPE': {
    title: 'Tipo de archivo no permitido',
    description: 'El tipo de archivo seleccionado no está permitido. Solo se aceptan: PDF, DOCX, XLSX, PNG, JPG.',
  ...
  'UNKNOWN_ERROR': {
    ...
    description: 'Ocurrió un error inesperado. Por favor intenta nuevamente o contacta al soporte técnico.',
    action: 'Reintentar',
    severity: 'error'
  },
};
