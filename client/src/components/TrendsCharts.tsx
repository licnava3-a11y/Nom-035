...
export default function TrendsCharts({ className }: TrendsChartsProps) {
  ...
  const [dateRange, setDateRange] = useState<
    "last30" | "last90" | "last180" | "currentYear"
  >("last90");
  ...
  const { data: coverageTrends, isLoading: loadingCoverage } =
        ...
        datasets: [
          {
            ...
            data: complianceTrends.current.map(
              item => item.porcentajeCumplimiento
            ),
            borderColor: "rgb(34, 197, 94)",
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Evolución de casos de riesgo psicosocial
                </CardDescription>
              </div>
              {casesTrends && (
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    className={getTrendColor(casesTrends.comparison.trend)}
                  >
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Encuestas completadas por guía
                </CardDescription>
              </div>
              {coverageTrends && (
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    className={getTrendColor(coverageTrends.comparison.trend)}
                  >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  ...
                  {complianceTrends &&
                    ` (${complianceTrends.totalEmployees} empleados totales)`}
                </CardDescription>
              </div>
              {complianceTrends && (
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    className={getTrendColor(complianceTrends.comparison.trend)}
                  >
