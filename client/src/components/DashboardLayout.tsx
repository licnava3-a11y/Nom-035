...
const hierarchicalMenuItems = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "📊 Centro de Retención (unificado)", path: "/retention-hub", description: "Vista unificada: rotación, empleados en riesgo, intervenciones y análisis predictivo" },
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "🔍 Consultar Folio (Buzón)", path: "/buzon/consulta", description: "Portal público para consultar el estado de una solicitud usando el folio generado" },
      ...
      { 
        ...
        submenu: [
          { label: "🔔 Centro de Alertas (unificado)", path: "/alerts-central", description: "Vista unificada: alertas activas, métricas, configuración e IA predictiva" },
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Historial SIRCE", path: "/sirce-history", description: "Registro de todos los archivos XML exportados para el Sistema de Registro de Constancias de Empresas (SIRCE-STPS) con opción de re-descarga." },
