...
export function ValidatedInput({
  ...
  const validateEmail = (
    ...
    if (localPart.length > 64) {
      return {
        valid: false,
        message: "La parte local del email es demasiado larga",
      };
    }
    ...
    if (domain.length > 255) {
      return {
        valid: false,
        message: "El dominio del email es demasiado largo",
      };
    }
    ...
    if (localPart.startsWith(".") || localPart.endsWith(".")) {
      return {
        valid: false,
        message: "El email no puede comenzar o terminar con punto",
      };
    }
