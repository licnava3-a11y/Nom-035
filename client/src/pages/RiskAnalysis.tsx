...
export default function RiskAnalysisPage() {
  ...
  const { data: results, isLoading: loadingResults } =
    trpc.surveys.getEmployeeResults.useQuery(
    ...
    <div className="container mx-auto py-8 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Genera reportes de análisis de riesgos psicosociales basados en
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Selecciona el empleado y el resultado de encuesta para generar el
            reporte de análisis
          </CardDescription>
        </CardHeader>
                  ...
                  {loadingResults ? (
                    ...
                    results?.map((result: any) => (
                      <SelectItem key={result.id} value={result.id.toString()}>
                        ...
                        - Nivel: {result.globalRiskLevel.toUpperCase()}
                      </SelectItem>
                    ))
                  )}
                </SelectContent>
            ...
            <Alert>
              ...
              <AlertDescription>
                <div className="space-y-1">
                  <p>
                    <strong>Empleado:</strong> {selectedEmployee.firstName}{" "}
                    {selectedEmployee.lastName}
                  </p>
                  <p>
                    <strong>Departamento:</strong>{" "}
                    {selectedEmployee.department || "No especificado"}
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    >
                      {selectedResult.globalRiskLevel
                        .toUpperCase()
                        .replace("_", " ")}
                    </span>
                  </p>
