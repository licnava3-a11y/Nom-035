      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardHeader>
            ...
            <CardDescription>
              Ocurrió un error al verificar el documento. Por favor intente
              nuevamente.
            </CardDescription>
          </CardHeader>
        </Card>
        ...
        <Card className="max-w-md w-full border-red-200">
          ...
          <CardContent>
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Este código QR puede ser fraudulento. Si recibió este documento
                de una fuente oficial, por favor contacte directamente con la
                organización emisora para verificar su autenticidad.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-green-700 mt-1">
                  Este documento ha sido verificado exitosamente y es auténtico
                  según la NOM-151
                </CardDescription>
              </div>
            </div>
        ...
        <CardContent className="pt-6 space-y-6">
          ...
          <Alert className="bg-green-50 border-green-200">
            ...
            <AlertDescription className="text-green-700">
              Este documento fue generado por el Sistema de Gestión NOM-035 STPS
              2018 y cuenta con trazabilidad completa. El código QR garantiza la
              autenticidad del documento según la normativa NOM-151 de gestión
              documental.
            </AlertDescription>
          </Alert>
          ...
          <div className="pt-4 border-t border-slate-200">
            <p className="text-xs text-slate-500 text-center">
              Código de verificación:{" "}
              <span className="font-mono font-semibold">{uuid}</span>
            </p>
          </div>
        </CardContent>
      </Card>
