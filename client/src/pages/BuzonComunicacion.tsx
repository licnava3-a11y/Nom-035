    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="rounded-lg border border-orange-100 bg-orange-50/40 p-3 space-y-3">
        <p className="text-xs font-semibold text-orange-700 flex items-center gap-1">
          <span>👤</span> Empleado Afectado (opcional — datos se guardan en el
          expediente del caso)
        </p>
          ...
          <div className="grid grid-cols-2 gap-2 mt-2">
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setForm(p => ({ ...p, affectedEmployeeName: e.target.value }))
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setForm(p => ({
                    ...p,
                    affectedEmployeeDepartment: e.target.value,
                  }))
                }
                className="h-8 text-sm"
              />
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setForm(p => ({
                    ...p,
                    affectedEmployeePosition: e.target.value,
                  }))
                }
                className="h-8 text-sm"
              />
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setForm(p => ({
                    ...p,
                    affectedEmployeeEmail: e.target.value,
                  }))
                }
                className="h-8 text-sm"
              />
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Input
            placeholder="Área, departamento, instalación..."
            value={form.incidentLocation}
            onChange={e =>
              setForm(p => ({ ...p, incidentLocation: e.target.value }))
            }
            required
          />
        </div>
      ...
      <div>
        ...
        <Input
          placeholder="Nombres o cargos (puede ser genérico si desea anonimato)"
          value={form.involvedPersons}
          onChange={e =>
            setForm(p => ({ ...p, involvedPersons: e.target.value }))
          }
        />
      </div>
      <div>
        ...
        <Textarea
          ...
          onChange={e =>
            setForm(p => ({ ...p, detailedNarrative: e.target.value }))
          }
          required
        />
        <p className="text-xs text-muted-foreground mt-1">
          {form.detailedNarrative.length}/50 caracteres mínimos
        </p>
      </div>
      <div>
        <Label>Descripción de evidencias</Label>
        <Textarea
          placeholder="Correos, mensajes, documentos, testigos..."
          rows={2}
          value={form.evidenceDescription}
          onChange={e =>
            setForm(p => ({ ...p, evidenceDescription: e.target.value }))
          }
        />
      </div>
      <div>
        ...
        <Input
          placeholder="¿Qué espera que se haga al respecto?"
          value={form.requestedAction}
          onChange={e =>
            setForm(p => ({ ...p, requestedAction: e.target.value }))
          }
        />
      </div>
      <div>
        ...
        <Input
          placeholder="Nombres o cargos de posibles testigos"
          value={form.witnessNames}
          onChange={e => setForm(p => ({ ...p, witnessNames: e.target.value }))}
        />
      </div>
      <div className="flex items-center gap-2">
        <Switch
          checked={form.previousReportFiled}
          onCheckedChange={v =>
            setForm(p => ({ ...p, previousReportFiled: v }))
          }
        />
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            value={form.recognizedName}
            onChange={e =>
              setForm(p => ({ ...p, recognizedName: e.target.value }))
            }
            required
          />
        </div>
        <div>
          ...
          <Input
            ...
            value={form.recognizedDepartment}
            onChange={e =>
              setForm(p => ({ ...p, recognizedDepartment: e.target.value }))
            }
          />
        </div>
      </div>
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            type="date"
            value={form.recognizedDate}
            onChange={e =>
              setForm(p => ({ ...p, recognizedDate: e.target.value }))
            }
          />
        </div>
        <div>
          ...
          <Select
            ...
            onValueChange={v =>
              setForm(p => ({ ...p, recognitionCategory: v }))
            }
          >
            <SelectTrigger>
              <SelectValue />
            ...
            <SelectContent>
              <SelectItem value="SERVICIO_EXCEPCIONAL">
                Servicio excepcional
              </SelectItem>
              <SelectItem value="TRABAJO_EN_EQUIPO">
                Trabajo en equipo
              </SelectItem>
      ...
      <div>
        ...
        <Textarea
          placeholder="Describa qué hizo la persona que merece reconocimiento..."
          rows={3}
          value={form.specificBehavior}
          onChange={e =>
            setForm(p => ({ ...p, specificBehavior: e.target.value }))
          }
          required
        />
      </div>
      <div>
        ...
        <Textarea
          placeholder="¿Cómo benefició al equipo, cliente o empresa?"
          rows={2}
          value={form.impactDescription}
          onChange={e =>
            setForm(p => ({ ...p, impactDescription: e.target.value }))
          }
        />
      </div>
      <div className="flex items-center gap-2">
        <Switch
          ...
          onCheckedChange={v => setForm(p => ({ ...p, publicRecognition: v }))}
        />
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <Input
          placeholder="Ej: Excel avanzado, Comunicación efectiva, NOM-035..."
          value={form.topic}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Select
            ...
            onValueChange={v => setForm(p => ({ ...p, trainingType: v }))}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              ...
              <SelectItem value="HABILIDADES_BLANDAS">
                Habilidades blandas
              </SelectItem>
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={v => setForm(p => ({ ...p, urgencyLevel: v }))}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
      ...
      <div>
        ...
        <Textarea
          placeholder="¿Por qué es necesaria esta capacitación? ¿Qué brecha de conocimiento cubre?"
          rows={3}
      ...
      <div>
        ...
        <Textarea
          placeholder="¿Cómo mejorará el desempeño o los resultados del área?"
          rows={2}
          value={form.expectedBenefit}
          onChange={e =>
            setForm(p => ({ ...p, expectedBenefit: e.target.value }))
          }
        />
      </div>
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Select
            ...
            onValueChange={v => setForm(p => ({ ...p, preferredFormat: v }))}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
      ...
      <div>
        ...
        <Input
          placeholder="Ej: Enero 2025, entre semana, mañanas..."
          value={form.preferredDates}
          onChange={e =>
            setForm(p => ({ ...p, preferredDates: e.target.value }))
          }
        />
      </div>
      <div>
        ...
        <Input
          placeholder="Nombre de empresa o instructor externo si tiene preferencia"
          value={form.externalProvider}
          onChange={e =>
            setForm(p => ({ ...p, externalProvider: e.target.value }))
          }
        />
      </div>
      <Button type="submit" disabled={loading} className="w-full">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <Textarea
          placeholder="¿Qué situación desea mejorar?"
          rows={3}
      ...
      <div>
        ...
        <Textarea
          placeholder="Describa su propuesta de mejora con el mayor detalle posible..."
          rows={4}
          value={form.proposedSolution}
          onChange={e =>
            setForm(p => ({ ...p, proposedSolution: e.target.value }))
          }
          required
        />
      </div>
      <div>
        <Label>Beneficio esperado</Label>
        <Textarea
          placeholder="¿Qué mejoraría con esta solución? (tiempo, costo, calidad, bienestar...)"
          rows={2}
          value={form.expectedBenefit}
          onChange={e =>
            setForm(p => ({ ...p, expectedBenefit: e.target.value }))
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Select
            value={form.implementationDifficulty}
            onValueChange={v =>
              setForm(p => ({ ...p, implementationDifficulty: v }))
            }
          >
            <SelectTrigger>
              <SelectValue />
        ...
        <div>
          ...
          <Input
            placeholder="Departamento o proceso"
            value={form.affectedArea}
            onChange={e =>
              setForm(p => ({ ...p, affectedArea: e.target.value }))
            }
          />
        </div>
      </div>
      <div>
        ...
        <Input
          placeholder="Presupuesto, personal, tecnología..."
          value={form.resourcesNeeded}
          onChange={e =>
            setForm(p => ({ ...p, resourcesNeeded: e.target.value }))
          }
        />
      </div>
      <Button type="submit" disabled={loading} className="w-full">
...
function RequestDetailModal({
  ...
  const { data, isLoading } = trpc.buzon.getRequestDetail.useQuery({
    id: requestId,
  });
  ...
  try {
    parsedPayload = JSON.parse(request.formPayload);
  } catch {
    /* empty */
  }
...
export default function BuzonComunicacion() {
  ...
  const [newRequestType, setNewRequestType] = useState<
    "QUEJA" | "FELICITACION" | "CAPACITACION" | "SUGERENCIA"
  >("QUEJA");
  const [anonymityFlag, setAnonymityFlag] = useState(false);
  const [newRequestOpen, setNewRequestOpen] = useState(false);
  const [autofillEmployeeId, setAutofillEmployeeId] = useState<
    string | undefined
  >(undefined);
  const [autofillData, setAutofillData] = useState<EmployeeAutofillData | null>(
    null
  );
  ...
  const handleAutofillSelect = (data: EmployeeAutofillData | null) => {
    ...
    if (data) {
      toast({
        ...
        description: `Empleado: ${data.fullName}`,
      });
    }
  };
  ...
  const { data: statsData } = trpc.buzon.getStats.useQuery(undefined, {
    enabled: isAdmin,
  });
  ...
  const handleSubmit =
    (type: typeof newRequestType) => (data: Record<string, unknown>) => {
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Canal seguro para quejas, felicitaciones, solicitudes de
        ...
        <Dialog open={newRequestOpen} onOpenChange={setNewRequestOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 p-3 bg-muted rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Tu nombre no será visible para el equipo de RH
                  </p>
                </div>
              </div>
              ...
              {newRequestType === "QUEJA" && (
                <QuejaForm
                  onSubmit={handleSubmit("QUEJA")}
                  loading={submitMutation.isPending}
                />
              )}
              {newRequestType === "FELICITACION" && (
                <FelicitacionForm
                  onSubmit={handleSubmit("FELICITACION")}
                  loading={submitMutation.isPending}
                />
              )}
              {newRequestType === "CAPACITACION" && (
                <CapacitacionForm
                  onSubmit={handleSubmit("CAPACITACION")}
                  loading={submitMutation.isPending}
                />
              )}
              {newRequestType === "SUGERENCIA" && (
                <SugerenciaForm
                  onSubmit={handleSubmit("SUGERENCIA")}
                  loading={submitMutation.isPending}
                />
              )}
            </div>
          ...
          {statsData.byType.map(t => (
            <Card key={t.requestType}>
              <CardContent className="pt-4">
                <div className="flex items-center gap-2">
                  <span className={typeColors[t.requestType]}>
                    {typeIcons[t.requestType]}
                  </span>
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {t.requestType === "QUEJA"
                        ? "Quejas"
                        : t.requestType === "FELICITACION"
                          ? "Felicitaciones"
                          : t.requestType === "CAPACITACION"
                            ? "Solicitudes DNC"
                            : "Sugerencias"}
                    </p>
                  </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-sm text-muted-foreground">
            Usa el botón "Nueva Solicitud" para enviar una
          </p>
        </div>
      ) : (
        <div className="space-y-2">
          {listData.requests.map(req => (
            ...
            >
              <div className="flex items-center gap-3">
                <span className={typeColors[req.requestType]}>
                  {typeIcons[req.requestType]}
                </span>
                <div>
