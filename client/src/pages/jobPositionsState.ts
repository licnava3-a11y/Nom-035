...
export type RiskDistribution = Record<"muy_alto" | "alto" | "medio" | "bajo", number>;

export function getRiskDistribution(positions: Array<{ riskLevel: string }>): RiskDistribution {
  return positions.reduce<RiskDistribution>((distribution, position) => {
