...
export default function NineBoxGrid() {
      ...
      departmentId:
        departmentFilter === "all"
          ...
          : departmentFilter
            ...
            : undefined,
      quadrant:
        quadrantFilter === "all" ? undefined : quadrantFilter || undefined,
      page,
      pageSize: 50,
    }
  );
  ...
  const handleCalculateAll = () => {
    if (
      window.confirm(
        "¿Desea calcular automáticamente las evaluaciones Nine Box para todos los empleados?"
      )
    ) {
  ...
  const getQuadrantColor = (quadrant: string) => {
    if (quadrant.includes("Alto Desempeño / Alto Potencial"))
      return "bg-green-100 text-green-800 border-green-300";
    if (quadrant.includes("Alto Desempeño"))
      return "bg-blue-100 text-blue-800 border-blue-300";
    if (quadrant.includes("Alto Potencial"))
      return "bg-purple-100 text-purple-800 border-purple-300";
    if (quadrant.includes("Medio Desempeño / Medio Potencial"))
      return "bg-yellow-100 text-yellow-800 border-yellow-300";
    if (quadrant.includes("Bajo Desempeño"))
  ...
  const quadrants = [
    {
      name: "Alto Desempeño / Alto Potencial",
      perf: 3,
      pot: 3,
      color: "bg-green-500",
    },
    {
      name: "Alto Desempeño / Medio Potencial",
      perf: 3,
      pot: 2,
      color: "bg-blue-500",
    },
    {
      name: "Alto Desempeño / Bajo Potencial",
      perf: 3,
      pot: 1,
      color: "bg-blue-300",
    },
    {
      name: "Medio Desempeño / Alto Potencial",
      perf: 2,
      pot: 3,
      color: "bg-purple-500",
    },
    {
      name: "Medio Desempeño / Medio Potencial",
      perf: 2,
      pot: 2,
      color: "bg-yellow-500",
    },
    {
      name: "Medio Desempeño / Bajo Potencial",
      perf: 2,
      pot: 1,
      color: "bg-yellow-300",
    },
    {
      name: "Bajo Desempeño / Alto Potencial",
      perf: 1,
      pot: 3,
      color: "bg-purple-300",
    },
    {
      name: "Bajo Desempeño / Medio Potencial",
      perf: 1,
      pot: 2,
      color: "bg-orange-300",
    },
    {
      name: "Bajo Desempeño / Bajo Potencial",
      perf: 1,
      pot: 1,
      color: "bg-red-500",
    },
  ...
  const getQuadrantCount = (quadrantName: string) => {
    return (
      stats?.byQuadrant.find((q: any) => q.quadrant === quadrantName)?.count ||
      0
    );
  };
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              {stats?.byQuadrant
                .filter((q: any) => q.quadrant.includes("Alto Potencial"))
                .reduce((sum: any, q: any) => sum + q.count, 0) || 0}
            </div>
            <p className="text-xs text-muted-foreground">
              Candidatos para sucesión
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">
              {stats?.byQuadrant
                .filter((q: any) => q.quadrant.includes("Bajo Desempeño"))
                .reduce((sum: any, q: any) => sum + q.count, 0) || 0}
            </div>
            <p className="text-xs text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              No se encontraron evaluaciones. Haga clic en "Calcular
              Automáticamente" para generar.
            </div>
          ) : (
            <>
              <Table>
                    ...
                    <TableRow key={assessment.id}>
                      ...
                      <TableCell>
                        <Badge variant="outline">
                          {assessment.performanceScore === 3
                            ? "Alto"
                            : assessment.performanceScore === 2
                              ? "Medio"
                              : "Bajo"}
                        </Badge>
                      </TableCell>
                      ...
                      <TableCell>
                        <Badge
                          className={getQuadrantColor(assessment.quadrant)}
                        >
                          {assessment.quadrant}
                        </Badge>
                      </TableCell>
              ...
              {assessmentsData && assessmentsData.totalPages > 1 && (
                <div className="flex justify-between items-center mt-4">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setPage(p => Math.min(assessmentsData.totalPages, p + 1))
                    }
