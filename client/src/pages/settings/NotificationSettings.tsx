...
const ALERT_TYPES = [
  {
    ...
    description: "Avisos críticos de la plataforma, errores y mantenimiento",
    icon: AlertTriangle,
    color: "text-red-500",
  },
  {
    ...
    description: "Nuevos casos asignados, actualizaciones y cierres",
    icon: ShieldAlert,
  ...
  },
  {
    ...
    description:
      "Recordatorios de encuestas pendientes y resultados disponibles",
    icon: ClipboardList,
    color: "text-blue-500",
  },
  {
    key: "correctiveActionsEnabled",
    label: "Acciones correctivas",
    description:
      "Vencimientos de acciones correctivas y planes de intervención",
    icon: FileText,
  ...
  },
  {
    ...
    label: "Recordatorios",
    description: "Vencimientos de contratos, vacaciones pendientes y tareas",
    icon: Clock,
  ...
  },
  {
    ...
    description:
      "Reportes ejecutivos, análisis de riesgo y dashboards programados",
    icon: FileText,
    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Alertas inmediatas sin necesidad de recargar la página
                </p>
              </div>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <Label htmlFor="emailCh" className="cursor-pointer">
                  Notificaciones por correo electrónico
                </Label>
                <p className="text-xs text-muted-foreground mt-0.5">
                  Recibe alertas en tu correo registrado en el perfil
                </p>
              </div>
            </div>
            <Switch
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Selecciona qué categorías de notificaciones deseas recibir
              </CardDescription>
            </div>
            <Badge variant="outline" className="text-xs">
              {activeAlerts}/{ALERT_TYPES.length} activas
            </Badge>
          </div>
        </CardHeader>
            ...
            return (
              <div key={type.key}>
                ...
                <div className="flex items-center justify-between py-1">
                  ...
                  <Switch
                    id={type.key}
                    checked={alertTypes[type.key]}
                    onCheckedChange={v => handleAlertToggle(type.key, v)}
                  />
                </div>
              </div>
            );
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Recibe un correo con el resumen de actividades del día a la hora que
            elijas
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Recibe un correo con el resumen semanal de actividades el día que
            elijas
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
