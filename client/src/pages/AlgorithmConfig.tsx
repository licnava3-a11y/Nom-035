...
export default function AlgorithmConfig() {
  ...
  const { data: config, isLoading: configLoading } = trpc.departments.getAlgorithmConfig.useQuery();
  ...
  // Calcular suma total
  const totalWeight = rotationWeight + tenureWeight + managerWeight + teamSizeWeight;
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold">Configuración del Algoritmo Predictivo</h1>
          <p className="text-muted-foreground mt-2">
            Ajusta los pesos de los factores que determinan el score de riesgo de rotación
          </p>
        </div>
        ...
        <div className="grid gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ajusta la importancia relativa de cada factor. La suma debe ser exactamente 100%.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Peso de la antigüedad promedio de los empleados del departamento
                </p>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                El algoritmo predictivo calcula un score de riesgo (0-100) para cada departamento
                basándose en cuatro factores principales:
              </p>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  <span className="font-semibold text-foreground">• Tasa de Rotación:</span>
                  Mide las altas y bajas recientes. Mayor rotación = mayor riesgo.
                </li>
                <li className="flex items-start gap-2">
                  <span className="font-semibold text-foreground">• Antigüedad Promedio:</span>
                  Equipos con baja antigüedad tienen mayor probabilidad de rotación.
                </li>
                <li className="flex items-start gap-2">
                  <span className="font-semibold text-foreground">• Ausencia de Manager:</span>
                  Departamentos sin liderazgo claro tienen mayor riesgo de deserción.
                </li>
                <li className="flex items-start gap-2">
                  <span className="font-semibold text-foreground">• Tamaño del Equipo:</span>
                  Equipos muy pequeños o muy grandes pueden tener mayor inestabilidad.
                </li>
              </ul>
              <div className="pt-4 border-t">
                <p className="text-sm font-medium">Niveles de Riesgo:</p>
                <ul className="mt-2 space-y-1 text-sm text-muted-foreground">
                  <li>• <span className="text-green-600 font-medium">Bajo (0-30):</span> Departamento estable</li>
                  <li>• <span className="text-yellow-600 font-medium">Medio (31-60):</span> Requiere monitoreo</li>
                  <li>• <span className="text-red-600 font-medium">Alto (61-100):</span> Acción inmediata requerida</li>
                </ul>
              </div>
            </CardContent>
          </Card>
