...
export default function SignatureTest() {
  ...
  const { data: signatures, refetch } =
    trpc.signatures.getSignaturesByDocument.useQuery(
    ...
    <div className="container mx-auto py-8 space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Componente de prueba para validar la captura, conversión y
      ...
      <Card className="p-6 bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm">
          <li>
            Haz clic en "Abrir Panel de Firma" para mostrar el componente
            SignaturePad
          </li>
          <li>Firma en el área designada usando mouse o pantalla táctil</li>
          <li>
            Haz clic en "Guardar Firma" para subir a S3 y guardar en base de
            datos
          </li>
          <li>
            Verifica que la firma se muestre correctamente en la sección de
            "Firma Guardada"
          </li>
          <li>
            Haz clic en "Cargar Firmas del Documento" para ver todas las firmas
            asociadas
          </li>
        </ol>
      </Card>
              ...
              <div key={sig.id} className="border rounded-lg p-4 space-y-3">
                ...
                <div className="text-xs text-muted-foreground space-y-1">
                  ...
                  <p className="truncate">
                    Dispositivo: {sig.deviceInfo || "No disponible"}
                  </p>
                </div>
              </div>
            ))}
