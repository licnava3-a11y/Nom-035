                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Badge>{question.points} {question.points === 1 ? 'punto' : 'puntos'}</Badge>
                      {question.questionType === 'multiple_choice' && <Badge variant="secondary">Opción múltiple</Badge>}
                      {question.questionType === 'true_false' && <Badge variant="secondary">Verdadero/Falso</Badge>}
                      {question.questionType === 'short_answer' && <Badge variant="secondary">Respuesta corta</Badge>}
                    </div>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                ...
                (formData.questionType !== 'short_answer' && !formData.options.some(o => o.isCorrect)) ||
                addQuestionMutation.isPending ||
                updateQuestionMutation.isPending
              }
            >
              {editingQuestion
                ? (updateQuestionMutation.isPending ? 'Actualizando...' : 'Actualizar Pregunta')
                : (addQuestionMutation.isPending ? 'Agregando...' : 'Agregar Pregunta')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
