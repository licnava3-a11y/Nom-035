...
export default function Cases() {
  ...
  const { data: casesResponse, isLoading } = trpc.cases.list.useQuery(
    queryParams,
    {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      if (filterPriority !== "all")
        exportParams.priority = filterPriority as any;
  ...
  const handleAutoAssign = async (caseId: number) => {
    try {
      ...
      alert(
        `Caso asignado automáticamente a ${result.assignedTo.name} (${result.assignedTo.workload} casos activos)`
      );
    } catch (error: any) {
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-sm text-muted-foreground text-center">
              Solo los miembros del comité y administradores pueden acceder a
              esta sección.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Seguimiento de casos psicosociales
            </p>
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Listado completo de casos de riesgo psicosocial
          </CardDescription>
        </CardHeader>
        <CardContent>
