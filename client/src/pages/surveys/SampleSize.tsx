...
export default function SampleSize() {
  ...
  const { data: stats, isLoading } = trpc.surveys.getSampleSizeStats.useQuery({ surveyId: 3 });
    ...
    <div className="container py-8 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Estadísticas de muestra requerida según NOM-035-STPS-2018 para Guía III (Cuestionario de evaluación del entorno organizacional)
        </p>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          El tamaño de muestra se calcula con nivel de confianza del <strong>{stats.confidenceLevel}%</strong> y margen de error del <strong>{stats.marginOfError}%</strong> según la fórmula para población finita de la NOM-035.
        </AlertDescription>
      </Alert>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Total de Trabajadores</p>
        ...
        <Card className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold">{stats.percentageCompleted.toFixed(1)}%</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card className="p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
          ...
          <div className="text-center p-4 bg-muted rounded-lg">
            <p className="text-2xl font-bold text-orange-600">{stats.sampleSize}</p>
          ...
          <div className="text-center p-4 bg-muted rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">Respuestas Obtenidas</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6 space-y-4">
        <h2 className="text-xl font-semibold">Información sobre el Tamaño de Muestra</h2>
        ...
        <div className="space-y-3 text-sm">
          ...
          <p className="text-muted-foreground">
            La NOM-035-STPS-2018 establece que para organizaciones con más de 50 trabajadores, 
            se debe aplicar la Guía III a una muestra representativa de la población. El tamaño 
            de muestra calculado garantiza que los resultados sean estadísticamente significativos 
            y representativos de toda la organización.
          </p>
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1">
            <li>Asegúrese de que la muestra sea aleatoria y representativa de todos los departamentos</li>
            <li>Considere incluir trabajadores de diferentes turnos, puestos y antigüedades</li>
            <li>Garantice la confidencialidad de las respuestas para obtener resultados honestos</li>
            <li>Una vez alcanzado el tamaño de muestra, los resultados serán válidos para el reporte final</li>
          </ul>
        </div>
      </Card>
    </div>
