...
export default function SurveyResults() {
  ...
  const { data, isLoading, error } = trpc.surveys.getResults.useQuery(
    responseId!,
    {
      enabled: !!responseId,
    }
    ...
    <div className="container py-8 space-y-6">
      ...
      <Card className={`p-8 ${riskConfig.bg} ${riskConfig.border} border-2`}>
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className={`text-4xl font-bold ${riskConfig.text}`}>
              {riskLevel}
            </p>
            {results.category && (
      ...
      <Card className="p-6 bg-muted/50">
        ...
        <div className="space-y-2 text-sm text-muted-foreground">
          <p>
            • Los resultados se calcularon según las tablas oficiales de la
            NOM-035-STPS-2018.
          </p>
          <p>
            • Estos resultados son confidenciales y solo pueden ser consultados
            por el trabajador y el coordinador de seguridad.
          </p>
          <p>
            • Las recomendaciones son orientativas y deben ser implementadas por
