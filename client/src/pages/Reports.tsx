...
export default function Reports() {
  const {
    ...
    error,
    refetch,
  } = trpc.dashboard.getReportsMetrics.useQuery();
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Indicadores consolidados a partir de registros persistidos del
            sistema.
          </p>
        </div>
        <Button
        ...
        <Card className="border-destructive/40 bg-destructive/5">
          <CardContent className="flex flex-col justify-between gap-3 pt-6 sm:flex-row sm:items-center">
            <p className="text-sm text-destructive">
              No fue posible cargar métricas verificables. Intenta actualizar de
              nuevo.
            </p>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <MetricCard
          title="Participantes"
          value={stats?.trainedParticipants}
          description="Asignaciones de personal completadas"
        ...
        <MetricCard
          ...
          value={stats ? `${stats.nom035Compliance}%` : undefined}
          description="Respuestas concluidas / empleados activos"
      ...
      {!isLoading && !error && !metrics?.hasData && (
        <Card>
          <CardContent className="py-10 text-center text-sm text-muted-foreground">
            Aún no hay registros suficientes para calcular métricas. Las
            gráficas se habilitarán al registrar empleados, encuestas,
            capacitaciones o casos.
          </CardContent>
        </Card>
      )}
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <ChartCard
          ...
          description="Asignaciones completadas y en progreso registradas"
        >
        ...
        <ChartCard
          ...
          description="Casos de riesgo psicosocial por tipo"
        >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <ChartCard
          title="Cumplimiento NOM-035"
          description="Porcentaje actual de respuestas concluidas"
        >
        ...
        <ChartCard
          ...
          description="Cursos publicados registrados por categoría"
        >
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <ReportCard
            ...
            description="Listado de capacitaciones, asignaciones y certificaciones"
            pdf="/api/export/training/pdf"
            excel="/api/export/training/excel"
          />
          <ReportCard
            title="Reporte de Casos"
            description="Estadísticas y seguimiento de casos de riesgo psicosocial"
            pdf="/api/export/cases/pdf"
            excel="/api/export/cases/excel"
            icon={<AlertCircle className="h-6 w-6 text-primary" />}
          />
          <ReportCard
            title="Reporte de Cumplimiento"
            description="Indicadores NOM-035 y áreas de mejora"
            pdf="/api/export/compliance/pdf"
            excel="/api/export/compliance/excel"
            icon={<BarChart3 className="h-6 w-6 text-primary" />}
          />
          <ReportCard
            title="Reporte de Participantes"
            description="Progreso individual y certificaciones por empleado"
            pdf="/api/export/training/pdf"
            excel="/api/export/training/excel"
      ...
      <CardContent>
        <div className="flex gap-2">
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.open(excel, "_blank", "noopener,noreferrer")}
          >
            <Download className="mr-2 h-4 w-4" />
            Excel
          </Button>
