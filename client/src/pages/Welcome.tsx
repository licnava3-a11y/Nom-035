    ...
    <div className="min-h-screen bg-[#0f172a] text-white flex flex-col">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 flex-shrink-0">
              <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                ...
                <polygon points="16,22 24,18 16,14 8,18" fill="none" stroke="#22c55e" strokeWidth="1.5" strokeLinejoin="round"/>
                <polygon points="16,18 24,14 16,10 8,14" fill="none" stroke="#22c55e" strokeWidth="1.5" strokeLinejoin="round"/>
                <polygon points="16,14 24,10 16,6 8,10" fill="none" stroke="#22c55e" strokeWidth="1.5" strokeLinejoin="round"/>
              </svg>
            </div>
            <div>
              <div className="text-sm font-semibold text-white leading-tight">NOM-035 STPS 2018</div>
              <div className="text-xs text-slate-400 leading-tight">Plataforma de Gestión</div>
            </div>
          </div>
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <p className="text-slate-400 text-lg max-w-2xl mb-10 leading-relaxed">
          Plataforma todo-en-uno para cumplir con la NOM-035 STPS 2018. Administra empleados,
          aplica encuestas, genera reportes ejecutivos y mantén el cumplimiento normativo de
          tu organización desde un solo lugar.
        </p>
      ...
      {/* Módulos */}
      <section id="modules" className="px-6 py-16 bg-slate-800/30 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-white mb-3">Módulos de la plataforma</h2>
            <p className="text-slate-400 max-w-xl mx-auto">
              Todo lo que necesitas para gestionar el cumplimiento de la NOM-035 en tu organización.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {modules.map((mod) => (
              ...
              >
                ...
                <div>
                  <div className="font-semibold text-white text-sm mb-1">{mod.title}</div>
      ...
      <section className="px-6 py-14 text-center border-t border-white/5">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-slate-400 text-sm mb-6">
            Inicia sesión con tu cuenta institucional para acceder a todos los módulos de la plataforma.
          </p>
          <a
            href={loginUrl}
            className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-400 text-white font-semibold px-8 py-3 rounded-xl text-base transition-colors shadow-lg shadow-green-500/20"
      ...
      <footer className="border-t border-white/5 px-6 py-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
          ...
          <span>Cumplimiento normativo · Gestión de riesgos psicosociales · STPS México</span>
        </div>
      </footer>
    </div>
  );
