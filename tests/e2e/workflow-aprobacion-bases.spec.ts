...
test.describe('Workflow de Aprobación de Bases de Funcionamiento', () => {
  ...
  test('Crear y aprobar base de funcionamiento completa', async ({ page }) => {
  ...
  test('Validación en tiempo real funciona correctamente', async ({ page }) => {
    // Login y navegación
    const loginButton = page.locator('text=Acceder a la Plataforma');
    if (await loginButton.isVisible()) {
      await loginButton.click();
  ...
  test('Confirmación de salida con cambios sin guardar', async ({ page }) => {
    // Login y navegación
    const loginButton = page.locator('text=Acceder a la Plataforma');
    if (await loginButton.isVisible()) {
      await loginButton.click();
  ...
  test('Recuperación de borradores al volver', async ({ page }) => {
    // Login y navegación
    const loginButton = page.locator('text=Acceder a la Plataforma');
    if (await loginButton.isVisible()) {
      await loginButton.click();
