  ...
  getEvidences: protectedProcedure
    ...
    .query(
      async ({
        ...
        input: { companySize: "small" | "medium" | "large" };
      }) => {
        ...
        const evidences: {
          ...
          "5.2": {
            title:
              "5.2 Medidas de prevención y acciones de control de factores de riesgo psicosocial",
          ...
          "5.4": {
            title:
              "5.4 Identificación y análisis de los factores de riesgo psicosocial",
            required: true,
            description:
              "Identificar y analizar los factores de riesgo psicosocial mediante Guía de referencia I o cuestionarios",
            evidences: [],
            status: "pending",
          },
          ...
          "5.5": {
            ...
            required: companySize !== "small",
            description:
              "Evaluar el entorno organizacional favorable mediante cuestionarios de la Guía de referencia II o III",
            evidences: [],
            status: "pending",
          },
          ...
          "5.7": {
            ...
            required: true,
            description:
              "Difundir información a los trabajadores sobre la política, medidas adoptadas y mecanismos de atención",
            evidences: [],
            status: "pending",
          },
          ...
          "5.8": {
            ...
            description:
              "Conservar los registros sobre identificación, análisis, evaluación, medidas de control y seguimiento",
            evidences: [],
            status: "pending",
          },
        };
        ...
        if (companySize !== "small") {
          ...
          evidences["5.3"].status =
            traumaticCases.length > 0 ? "complete" : "pending";
        }
        ...
        if (companySize === "small") {
          evidences["5.4"].evidences.push({
            ...
            description:
              "Cuestionario aplicado para identificar factores de riesgo psicosocial",
            date: new Date().toISOString(),
            status: "pending",
          });
        }
        ...
        if (companySize !== "small") {
          ...
          evidences["5.5"].status =
            nom035Surveys.length > 0 ? "complete" : "pending";
        }
        ...
        evidences["5.6"].status =
          (coursesCount[0]?.count || 0) > 0 ? "complete" : "pending";
        ...
        evidences["5.7"].evidences.push({
          ...
          description:
            "Constancias de capacitación, carteles, correos electrónicos de difusión",
          date: new Date().toISOString(),
          status: "pending",
        });
        ...
        if (companySize === "large") {
          evidences["5.8"].evidences.push({
            ...
            description:
              "Base de datos con historial completo de identificación, análisis, evaluación y seguimiento",
            date: new Date().toISOString(),
            status: "active",
          });
      ...
      async ({
        ...
        return new Promise<{ pdfBase64: string }>((resolve, reject) => {
          ...
          doc
            .fontSize(24)
            .font("Helvetica-Bold")
            .text("CARPETA DE EVIDENCIAS STPS", { align: "center" });
          doc.moveDown();
          doc
            .fontSize(18)
            .text("Cumplimiento NOM-035-STPS-2018", { align: "center" });
          doc.moveDown(2);
          doc
            .fontSize(12)
            .font("Helvetica")
            .text(`Total de Empleados: ${totalEmployees}`, { align: "center" });
          doc.text(
            `Tamaño de Empresa: ${companySize === "small" ? "Pequeña (≤15)" : companySize === "medium" ? "Mediana (16-50)" : "Grande (>50)"}`,
            { align: "center" }
          );
          doc.moveDown(2);
          doc.text(
          ...
          doc
            .fontSize(16)
            .font("Helvetica-Bold")
            .text("EVIDENCIAS POR NUMERAL", { align: "center" });
          doc.moveDown(2);
          ...
          numerals.forEach((numeral: any) => {
            ...
            doc
              .fontSize(10)
              .font("Helvetica")
              .text("Evidencias recopiladas automáticamente del sistema.", {
                indent: 20,
              });
            doc.moveDown(1);
          });
