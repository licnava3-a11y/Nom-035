/**
 * Plantilla HTML profesional para Formato DC-3 STPS
...
export function getDC3Template(): string {
  return `
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Constancia de Habilidades Laborales DC-3 - {{folio}}</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  <div class="container">
    ...
    <div class="skills-section">
      <h3>Habilidades Laborales Adquiridas</h3>
