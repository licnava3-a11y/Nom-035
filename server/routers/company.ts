...
export const companyRouter = router({
  ...
  legalRepresentative: router({
    ...
    listActive: protectedProcedure.query(async () => {
      ...
      return allReps.filter((rep: any) => rep.activo && rep.firmaUrl);
    }),
    ...
    create: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const id = await companyDb.createLegalRepresentative({
          ...
          actaConstitutiva: input.actaConstitutiva,
          poderNotarial: input.poderNotarial,
          firmaUrl,
          firmaKey,
          certificadoUrl,
          certificadoKey,
    ...
    create: protectedProcedure
      .input(
        z.object({
          ...
          fechaFin: z.string(),
          guiaAplicada: z.enum(["guia-i", "guia-ii", "guia-iii"]).optional(),
          tamañoMuestra: z.number().int().positive().optional(),
          cobertura: z.number().optional(),
          numeroTrabajadoresTotal: z.number().int().positive().optional(),
          numeroTrabajadoresEncuestados: z.number().int().positive().optional(),
          ...
          nombreCentroTrabajo: z.string().optional(),
          domicilioCentroTrabajo: z.string().optional(),
          actividadPrincipal: z.string().optional(),
          objetivoInforme: z.string().optional(),
          ...
          nombreResponsableEvaluacion: z.string().optional(),
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const id = await companyDb.createSurveyReport({
          ...
          guiaAplicada: input.guiaAplicada || "guia-i",
          ...
          nombreCentroTrabajo: input.nombreCentroTrabajo,
          domicilioCentroTrabajo: input.domicilioCentroTrabajo,
          actividadPrincipal: input.actividadPrincipal,
          objetivoInforme: input.objetivoInforme,
          actividadesRealizadas: input.actividadesRealizadas,
          metodoUtilizado: input.metodoUtilizado,
          resultadosObtenidos: input.resultadosObtenidos,
          nivelRiesgoGeneral: input.nivelRiesgoGeneral,
          conclusiones: input.conclusiones,
          recomendaciones: input.recomendaciones,
          accionesIntervencion: input.accionesIntervencion,
          nombreResponsableEvaluacion: input.nombreResponsableEvaluacion,
