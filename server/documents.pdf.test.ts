...
import { calculateSignatureHash, prepareSignatureData } from './lib/signatureUtils';
...
describe('Document PDF Generation and Signature Validation', () => {
  describe('Signature Hash Calculation', () => {
    ...
    it('should produce different hash for different signatures', () => {
      const signature1 = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==';
      const signature2 = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==';
  ...
  describe('PDF Generator Module', () => {
    ...
    it('should export generateActaFinalResultadosPDF function', async () => {
      ...
      expect(typeof pdfGenerator.generateActaFinalResultadosPDF).toBe('function');
    });
