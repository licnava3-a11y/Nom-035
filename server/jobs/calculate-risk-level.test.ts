 ...
 */
export function calculateRiskLevelFromScore(scorePercentage: number): 'low' | 'medium' | 'high' | 'very_high' {
 ...
 */
export function generateRecommendations(riskLevel: 'low' | 'medium' | 'high' | 'very_high'): string[] {
 ...
 */
export function calculateTotalScore(answers: Answer[]): { totalScore: number; maxPossibleScore: number; scorePercentage: number } {
 ...
 */
export function calculateCategoryScores(totalScore: number, maxPossibleScore: number, scorePercentage: number): CategoryScore[] {
  return [
    {
...
describe('Cálculo de Nivel de Riesgo NOM-035', () => {
  ...
  describe('generateRecommendations', () => {
    ...
    it('debe generar 3 recomendaciones para riesgo alto', () => {
      ...
      expect(recommendations).toContain('Evaluación de factores de riesgo específicos');
  ...
  describe('calculateTotalScore', () => {
    ...
    it('debe calcular correctamente caso de riesgo muy alto (>70%)', () => {
      ...
      expect(calculateRiskLevelFromScore(result.scorePercentage)).toBe('very_high');
    });
  ...
  describe('Integración: Flujo completo de cálculo de riesgo', () => {
    it('debe procesar correctamente una encuesta completa de riesgo medio', () => {
      ...
      const { totalScore, maxPossibleScore, scorePercentage } = calculateTotalScore(answers);
