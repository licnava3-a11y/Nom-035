 ...
 * 
 * Uso: npx ts-node server/dc1Generator.demo.ts
 */
...
function generateDC1(employee: any, course: any, completedDate: Date, percentage: number): string {
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>Formato DC-1 | Capacitación Corporativa</p>
    </div>
    ...
    <div class="footer">
      <p>Este documento certifica que el trabajador ha completado exitosamente la capacitación indicada.</p>
...
function generateSIRCEXml(employee: any, course: any, completedDate: Date, percentage: number): string {
...
function generateSIRCEBatch(records: any[], startDate: Date, endDate: Date): string {
