...
export async function generateNom035ReportDocx(
    ...
    sections: [
      {
        ...
        children: [
          ...
          createDataTable([
            [
              "Fecha de Inicio",
              data.reportPeriod.startDate.toLocaleDateString("es-MX"),
            ],
            [
              "Fecha de Término",
              data.reportPeriod.endDate.toLocaleDateString("es-MX"),
            ],
          ]),
          ...
          createDataTable([
            ...
            [
              ...
              data.surveyResults.guideI.applied
                ? `${data.surveyResults.guideI.casesIdentified} casos identificados`
                : "N/A",
            ],
            [
              "Guía II - Identificación y análisis (centros 16-50 trabajadores)",
              data.surveyResults.guideII.applied ? "Sí" : "No",
              data.surveyResults.guideII.applied
                ? `${data.surveyResults.guideII.totalResponses} respuestas`
                : "N/A",
            ],
            [
              "Guía III - Identificación y análisis (centros +50 trabajadores)",
              data.surveyResults.guideIII.applied ? "Sí" : "No",
              data.surveyResults.guideIII.applied
                ? `${data.surveyResults.guideIII.totalResponses} respuestas`
                : "N/A",
            ],
          ]),
          ...
          ...(data.riskFactors.length > 0
            ...
            : [
                new Paragraph({
                  children: [
                    new TextRun({
                      text: "No se identificaron factores de riesgo psicosocial significativos en el período evaluado.",
                      italics: true,
                    }),
                  ],
                  spacing: { after: 240 },
          ...
          ...(data.controlMeasures.length > 0
            ...
            : [
                new Paragraph({
                  children: [
                    new TextRun({
                      text: "No se han implementado medidas de control específicas en el período evaluado.",
                      italics: true,
                    }),
                  ],
                  spacing: { after: 240 },
      ...
      new TableRow({
        children: [
          new TableCell({
            children: [
              new Paragraph({
                children: [new TextRun({ text: "Categoría", bold: true })],
              }),
            ],
            shading: { fill: "E8F4F8" },
          }),
          new TableCell({
            children: [
              new Paragraph({
                children: [new TextRun({ text: "Dominio", bold: true })],
              }),
            ],
            shading: { fill: "E8F4F8" },
          }),
          new TableCell({
            children: [
              new Paragraph({
                children: [new TextRun({ text: "Dimensión", bold: true })],
              }),
            ],
            shading: { fill: "E8F4F8" },
          }),
          ...
          new TableCell({
            children: [
              new Paragraph({
                children: [
                  new TextRun({ text: "Empleados Afectados", bold: true }),
                ],
              }),
            ],
            shading: { fill: "E8F4F8" },
        ...
        factor =>
          new TableRow({
            children: [
              ...
              new TableCell({
                children: [new Paragraph(factor.affectedEmployees.toString())],
              }),
            ],
          })
      ),
        ...
        children: [
          new TableCell({
            children: [
              new Paragraph({
                children: [
                  new TextRun({ text: "Factor de Riesgo", bold: true }),
                ],
              }),
            ],
            shading: { fill: "E8F4F8" },
          ...
          new TableCell({
            children: [
              new Paragraph({
                children: [
                  new TextRun({ text: "Medida de Control", bold: true }),
                ],
              }),
            ],
            shading: { fill: "E8F4F8" },
        ...
        measure =>
          new TableRow({
            children: [
              ...
              new TableCell({
                children: [new Paragraph(measure.responsiblePerson)],
              }),
              new TableCell({
                children: [
                  new Paragraph(measure.deadline.toLocaleDateString("es-MX")),
                ],
              }),
              new TableCell({
