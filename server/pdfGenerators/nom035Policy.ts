...
export async function generateNom035PolicyPDF(
  policy: PolicyData
): Promise<string> {
  ...
  doc
    .fontSize(18)
    .font("Helvetica-Bold")
    .text("POLÍTICA DE PREVENCIÓN DE RIESGOS PSICOSOCIALES", {
      align: "center",
    });
  ...
  doc
    .fontSize(16)
    .font("Helvetica-Bold")
    .text(policy.nombre, { align: "center" });
  ...
  doc
    ...
    .font("Helvetica")
    .text(
      `Fecha de publicación: ${policy.fechaPublicacion.toLocaleDateString(
        "es-MX",
        {
          year: "numeric",
          month: "long",
  ...
  if (legalRep) {
    ...
    doc
      .fontSize(11)
      .font("Helvetica-Bold")
      .text(legalRep.nombre || "", { align: "center" });
    doc
      .fontSize(10)
      .font("Helvetica")
  ...
  doc
    .fontSize(8)
    .font("Helvetica")
    .text("Código QR de validación NOM-151", 72, doc.page.height - 60, {
      width: 80,
      align: "center",
    });
  ...
  doc
    .fontSize(8)
    .font("Helvetica")
    .text(`Folio: ${folio}`, 200, doc.page.height - 50, { align: "center" });
