  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      doc
        .fontSize(16)
        .font("Helvetica-Bold")
        .text("BASES DE FUNCIONAMIENTO", 50, 80, {
          align: "center",
        });
      doc
        .fontSize(14)
        .text("COMITÉ DE SEGURIDAD Y SALUD EN EL TRABAJO", 50, 100, {
          align: "center",
        });
      ...
      doc
        .fontSize(10)
        .font("Helvetica-Bold")
        .text("Datos de la Empresa:", 50, doc.y);
      doc.font("Helvetica");
      ...
      doc.text(
        `Fecha de Aprobación: ${new Date(data.approvalDate).toLocaleDateString("es-MX")}`,
        50,
        doc.y + 5
      );
      ...
      doc
        .fontSize(10)
        .font("Helvetica-Bold")
        .text("Artículo 1. Objeto", 50, doc.y);
      doc
        .font("Helvetica")
        .text(
      ...
      doc
        .font("Helvetica-Bold")
        .text("Artículo 2. Fundamento Legal", 50, doc.y);
      doc
        .font("Helvetica")
        .text(
      ...
      doc
        .font("Helvetica-Bold")
        .text("Artículo 3. Ámbito de Aplicación", 50, doc.y);
      doc
        .font("Helvetica")
        .text(
      ...
      doc
        .fontSize(10)
        .font("Helvetica-Bold")
        .text("Artículo 4. Composición", 50, doc.y);
      doc
        .font("Helvetica")
        .text(
      ...
      data.members.forEach((member: any, index: number) => {
        doc.text(
          `${index + 1}. ${member.name} - ${member.position} (${member.department})`,
          70,
          doc.y + 5
        );
      });
      ...
      doc
        .font("Helvetica-Bold")
        .text("Artículo 5. Duración del Cargo", 50, doc.y);
      doc
        .font("Helvetica")
        .text(
      ...
      doc
        .fontSize(10)
        .font("Helvetica-Bold")
        .text("Artículo 6. Funciones Generales", 50, doc.y);
      doc
        .font("Helvetica")
        .text("El Comité tendrá las siguientes funciones:", 50, doc.y + 5, {
          align: "justify",
        });
      doc.moveDown(0.5);
      ...
      doc
        .fontSize(10)
        .font("Helvetica-Bold")
        .text("Artículo 7. Periodicidad", 50, doc.y);
      doc
        .font("Helvetica")
        .text(
      ...
      doc
        .fontSize(10)
        .font("Helvetica-Bold")
        .text("Artículo 11. Del Presidente", 50, doc.y);
      doc.font("Helvetica");
      doc.text(
      ...
      doc.text(
        "2. Vigilar el cumplimiento de los acuerdos tomados",
        70,
        doc.y + 5
      );
      doc.text(
        "3. Representar al Comité ante las autoridades competentes",
        70,
        doc.y + 5
      );
      doc.moveDown(1);
      ...
      doc.text(
        "2. Participar activamente en las deliberaciones",
        70,
        doc.y + 5
      );
      doc.text(
        "3. Ejecutar las comisiones que les sean encomendadas",
        70,
        doc.y + 5
      );
      ...
      doc
        .fontSize(12)
        .font("Helvetica-Bold")
        .text("FIRMAS DE CONFORMIDAD", 50, 50, { align: "center" });
      doc.moveDown(2);
      ...
      data.members.forEach((member: any, index: number) => {
        ...
        doc.text(member.name, 50, yPosition + signatureHeight + 15, {
          align: "center",
          width: 200,
        });
        doc.text(member.position, 50, yPosition + signatureHeight + 30, {
          align: "center",
          width: 200,
        });
      ...
      doc
        .fontSize(8)
        .text("Código QR NOM-151", 445, 785, { width: 90, align: "center" });
