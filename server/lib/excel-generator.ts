 ...
 */
export async function generateActionPlanExcel(options: ExcelGeneratorOptions): Promise<Buffer> {
  ...
  dateCell.value = `Fecha de generación: ${new Date().toLocaleDateString('es-MX', {
    year: 'numeric',
    month: 'long',
    day: 'numeric',
    hour: '2-digit',
  ...
  summaryTitleCell.font = { size: 14, bold: true, color: { argb: COLORS.primary } };
  ...
  footerCell.value = 'Plataforma de Capacitación NOM-035 STPS 2018 | Generado automáticamente';
