...
describe("canalización de calidad", () => {
  it("ejecuta tipos, seguridad de tipos y pruebas secuenciales", () => {
    ...
    expect(workflow).toContain(
      "DATABASE_URL: mysql://root:root@127.0.0.1:3306/nom035_test"
    );
